...
a.fillStyle="white",d=50,a.fillText("LIVES",P/2-d,400),J(a,P/2-d,422,0,30,30,"lives_icon"),a.fillText("LIVES",P/2+d,400),J(a,P/2+d,422,0,30,30,"lives_icon"),a.font="36px Muli",a.fillText(b.data.jE-b.data.Nm,P/2-d,470),Ua(a,P/2,430,20,"right","white",!1),a.fillText(b.data.jE,P/2+d,470));"ult"==b.type&&(a.textAlign="center",f="YOU HAVE EARNED AN UPGRADE!",c="EXTRA ULTIMATE",a.fillStyle="white",a.font="60px Muli",a.fillText("+"+b.data.Nm,P/2-25,270),J(a,P/2+35,250,0,40,40,"ultimate_icon"),a.font="72px Muli",
