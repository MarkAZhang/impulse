...
function Sb(a,b){for(var c=a.length-1,d=[],f=0;f<a.length;f++){var g=(f+1)%a.length,h=new box_2d.b2Vec2(a[f].y-a[c].y,a[c].x-a[f].x),c=new box_2d.b2Vec2(a[f].x-a[c].x,a[f].y-a[c].y),k=new box_2d.b2Vec2(a[g].y-a[f].y,a[f].x-a[g].x),g=new box_2d.b2Vec2(a[f].x-a[g].x,a[f].y-a[g].y);h.bb();k.bb();c.bb();g.bb();var n=S({x:0,y:0},k),q=S({x:0,y:0},h),n=n-q,n=0>n?n+2*Math.PI:n,n=n>=2*Math.PI?n-2*Math.PI:n;n>Math.PI?d.push({x:a[f].x+h.x*b-1*c.x/Math.tan(n/2-Math.PI/2)*b,y:a[f].y+h.y*b-1*c.y/Math.tan(n/2-Math.PI/2)*b}):n>5*Math.PI/6?
...
function ac(a,b,c,d,f,g,h,k){var n=new box_2d.b2BodyDef;n.type="static"==h?box_2d.b2Body.pf:box_2d.b2Body.Jd;n.position.x=c;n.position.y=d;n.Cs=3;a=a.ko(n);for(c=0;c<b.length;c++){d=b[c];h=null;"circle"==d.type&&(h=new box_2d.b2CircleShape(d.X),h.Vx(new box_2d.b2Vec2(d.x,d.y)));if("polygon"==d.type){n=[];for(h=0;h<d.ca.length;h++)n.push(new box_2d.b2Vec2(d.x+d.X*d.ca[h][0],d.y+d.X*d.ca[h][1]));h=new box_2d.b2PolygonShape;h.Vt(n,n.length)}d=new box_2d.b2FixtureDef;d.rb=f;d.$m=0;d.Fn=.7;d.filter.rf=g;d.filter.Af=6;d.shape=h;a.Xq(d).uo({body:a,owner:k,self:null})}return a}
...
l.ha=function(a,b,c,d){if(null!=a){"easy"==L&&(this.rb*=1.5,this.Xn*=1.5);var f=new box_2d.b2FixtureDef;f.rb=this.rb;f.$m=0;f.Fn=1;f.filter.rf=2;f.filter.Af=29;var g=new box_2d.b2BodyDef;g.type=box_2d.b2Body.Jd;f.shape=new box_2d.b2CircleShape(qc.prototype.oh);this.X=qc.prototype.oh;this.i=d.i;this.r=d;g.position.x=b;g.position.y=c;g.Cs=this.Na;this.body=a.ko(g);this.body.Xq(f).uo({owner:this,body:this.body,self:this});this.shape=f.shape;this.kh=[];for(a=0;4>a;a++)this.kh.push({X:.5,si:a*Math.PI/2});this.Pq=this.wp=this.right=
...
l.ha=function(a,b,c,d,f){this.tE=new box_2d.b2Vec2(b,c);if(this.r=f)this.i=f.i,this.q=f.q;this.sa=a;for(g in H[this.type])this[g]=H[this.type][g];this.qw=[];this.qw.push(new box_2d.b2Vec2(Math.cos(0*Math.PI),Math.sin(0*Math.PI)));this.qw.push(new box_2d.b2Vec2(Math.cos(5*Math.PI/6),Math.sin(5*Math.PI/6)));this.qw.push(new box_2d.b2Vec2(Math.cos(7*Math.PI/6),Math.sin(7*Math.PI/6)));this.wE=1E3;this.tz=3;this.bv=this.rw=0;this.ck=1500;this.Fl=!0;this.Tf=1.5;this.Dv=z.impulse_blue;g=new box_2d.b2BodyDef;g.type=box_2d.b2Body.Jd;g.position.x=
b;g.position.y=c;g.Cs=this.Na;g.pv=this.bH?!1:!0;g.pv||(g.cy=50);a&&(this.body=a.ko(g));this.iF=[];this.Dg=[];this.Ki=!1;this.Tp=500;for(var g=0;g<this.bc.length;g++){a=this.bc[g];b=null;"circle"==a.type&&(b=new box_2d.b2CircleShape(a.X),b.Vx(new box_2d.b2Vec2(a.x,a.y)));if("polygon"==a.type){c=[];for(b=0;b<a.ca.length;b++)c.push(new box_2d.b2Vec2(a.x+a.X*a.ca[b][0],a.y+a.X*a.ca[b][1]));b=new box_2d.b2PolygonShape;b.Vt(c,c.length)}a=new box_2d.b2FixtureDef;a.rb=this.rb;a.$m=0;a.Fn=.7;a.filter.rf=this.rf?this.rf:4;a.filter.Af=this.Af?
this.Af:30;a.shape=b;this.body&&this.body.Xq(a).uo({owner:this,body:this.body,self:this});this.iF.push(b);b instanceof box_2d.b2PolygonShape?this.Dg.push(b.Z):this.Dg.push(null)}this.Mf=!0;Oc(this);this.path=null;this.dx=0;this.cx=!1;this.id=d;this.Fh=this.K=!1;this.cb=this.Ky=500;this.sb=0;this.$=[0,0,0,0];this.la={};this.la.open=0;this.la.impulsed=0;this.la.invincible=0;this.la.disabled=0;this.Lz=!0;this.Vc=!1;this.gB=0;this.up=!0;this.Rd=this.ue=40;this.VF=10;this.ph=.3;this.Nd=!1;this.Bj=!0;this.Fw=
...
l.Se=function(a){if(!this.K){if(0<this.la.open&&("mote"==a.type||"troll"==a.type)){var b=this.body.p,c=this.body.Y/a.body.Y;a.body.ia(new box_2d.b2Vec2(.2*b.x*c,.2*b.y*c),a.body.g.position);this.body.to(new box_2d.b2Vec2(b.x*c/(1+c),b.y*c/(1+c)))}a===this.q?(this.r.ra&&!this.fn()&&50<this.body.p.hg()&&(b=this.body.p,c=this.body.Y/a.body.Y,a.body.ia(new box_2d.b2Vec2(b.x*c*.5,b.y*c*.5),a.body.g.position),this.body.to(new box_2d.b2Vec2(b.x*c/(1+c),b.y*c/(1+c)))),this.up&&this.Qc("hit_player"),this.ma()&&!this.Dz||this.$f(),Cc(this)||
...
l.Ef=function(a,b,c){this.zb&&(this.body.ia(new box_2d.b2Vec2(this.an()*b*Math.cos(c),this.an()*b*Math.sin(c)),this.body.h.o),this.we(a,b,c))};l.we=function(){this.rc=this.Up};l.Ql=function(){};l.Gc=function(){};l.tv=function(){};l.Wp=function(){};l.open=function(){};Zc.prototype=new Vc;l=Zc.prototype;l.constructor=Zc;
...
function cd(a,b,c){if(a.Mi)for(a.Mi=!1,b=0;b<a.fd.length;b++)c=a.fd[b],"spawn"==c.type&&cd(a,c,!0);else{if("attack"==b.type)b.tf.dir={x:b.body.g.position.x-a.body.g.position.x,y:b.body.g.position.y-a.body.g.position.y},b.body=null,b.Jm=0,a.gi=null,a.xr=!1,b.tf.body.ig(),b.tf=null,ec("b4attacker");else if("spawn"==b.type){a.gi=null;a.xr=!1;b.Jm=0;b.body=null;var d=S(a.body.g.position,b.tf.body.g.position),d=new box_2d.b2Vec2(Math.cos(d),Math.sin(d));d.aa(a.xF);b.tf.body.ia(d,b.tf.body.h.o);b.tf.zb=!0;b.tf.ks=
!1;1!=c&&b.tf.Gc(5E3,!0,!0);Oc(b.tf);b.tf.body.ig();b.tf=null;a.Qw=null;ec("b4spawner")}a.Eo=a.ky}}
l.zo=function(){for(var a=0;a<this.fd.length;a++){var b=this.fd[a],c=S(this.body.g.position,b.body.g.position);"body"==b.type?(b=ac(this.sa,H[this.type].xy,this.body.g.position.x+1.5*this.I*Math.cos(Math.PI/5)*Math.cos(c),this.body.g.position.y+1.5*this.I*Math.cos(Math.PI/5)*Math.sin(c),.1,17,"dynamic",this),b.tb(c),this.fd[a].body=b,c=new box_2d.b2Vec2(Math.cos(c),Math.sin(c)),c.bb(),c.aa(20),b.ia(c,b.h.o)):0<b.Vk&&(c=new box_2d.b2Vec2(Math.cos(c),Math.sin(c)),c.bb(),c.aa(30),this.fd[a].body.ia(c,this.fd[a].body.h.o))}};
...
l.Ef=function(a,b,c){this.zb&&(this.body.ia(new box_2d.b2Vec2(this.oe*b*Math.cos(c),this.oe*b*Math.sin(c)),this.body.h.o),this.we(a,b,c))};
...
this.La.lu=ac(this.sa,H[this.type].Zw,f+d+a-2*h,g,.01,8,"dynamic",this);this.eb.lu=gd(this,new box_2d.b2Vec2(f+d-h,g),this.body,this.La.lu);this.La.ll=ac(this.sa,H[this.type].Ov,f+d+2*a+b-4*h,g,.01,8,"dynamic",this);this.eb.ll=gd(this,new box_2d.b2Vec2(f+d+2*a-3*h,g),this.La.lu,this.La.ll);this.La.lh=ac(this.sa,H[this.type].uv,f+d+2*a+2*b-4*h+.25*c,g,.01,8,"dynamic",this);this.La.lh.tb(Math.PI/4);this.eb.lh=gd(this,new box_2d.b2Vec2(f+d+2*a+2*b-4*h+.25*c,g),this.La.ll,this.La.lh);this.La.ru=ac(this.sa,H[this.type].Zw,
f-(d+a-2*h),g,.01,8,"dynamic",this);this.eb.ru=gd(this,new box_2d.b2Vec2(f-(d-h),g),this.body,this.La.ru);this.La.rl=ac(this.sa,H[this.type].Ov,f-(d+2*a+b-4*h),g,.01,8,"dynamic",this);this.eb.rl=gd(this,new box_2d.b2Vec2(f-(d+2*a-3*h),g),this.La.ru,this.La.rl);this.La.rh=ac(this.sa,H[this.type].uv,f-(d+2*a+2*b-4*h+.25*c),g,.01,8,"dynamic",this);this.La.rh.tb(Math.PI/4);this.eb.rh=gd(this,new box_2d.b2Vec2(f-(d+2*a+2*b-4*h+.25*c),g),this.La.rl,this.La.rh);this.hl={};this.Ag={};this.fi={left:"none",right:"none"};this.Oz=
...
l.zo=function(){var a="lu ll lh ru rl rh".split(" ");this.rc=0;this.il.left=0;for(var b=this.il.right=0;b<a.length;b++){this.sa.rx(this.eb[a[b]]);var c=S(this.body.g.position,this.La[a[b]].g.position),c=new box_2d.b2Vec2(Math.cos(c),Math.sin(c));c.bb();c.aa(10);this.La[a[b]].ia(c,this.La[a[b]].h.o)}};
...
["rl","ru","rh"];"left"==c&&(d=["ll","lu","lh"]);c=void 0;for(c in d){var f=d[c];this.eb[f].yh(this.eb[f].ge(),this.eb[f].ge())}this.lf[arm]=this.wA}else{c=arm;if("left"==c){var f=S(this.La.lh.g.position,this.fi[c]),f=new box_2d.b2Vec2(Math.cos(f),Math.sin(f)),g=R(this.La.lh.g.position,this.fi[c]);this.eb.lu.Dd();10>g&&f.aa(g/10);"punching"==this.Ac[c]&&f.aa(this.CA);this.La.lh.ia(f,this.La.lh.h.o)}"right"==c&&(f=S(this.La.rh.g.position,this.fi[c]),f=new box_2d.b2Vec2(Math.cos(f),Math.sin(f)),g=R(this.La.rh.g.position,
...
c);a.open(1500);a.body.ia(b,a.body.h.o)}};l.move=function(){this.Xc()?this.body.ia(new box_2d.b2Vec2(.7*this.fc.x,.7*this.fc.y),this.body.h.o):this.body.ia(this.fc,this.body.h.o);this.Le(S({x:0,y:0},this.fc))};l.Ef=function(a,b){var c=new box_2d.b2Vec2(this.body.g.position.x-a.x,this.body.g.position.y-a.y);c.bb();c.aa(b);this.fc.Lg(c);this.vw=!0;this.open(this.ck)};
...
l.ai=function(a){this.Vc&&a.aa(this.og);this.Xc()&&a.aa(this.ph);a.aa(this.pa)};l.Hd=function(){this.Vc=!this.K&&this.path&&1==this.path.length&&!this.ma()&&this.Ee};l.$f=function(){if(!this.ma()){var a=S(this.body.g.position,this.q.body.g.position);new box_2d.b2Vec2(this.Jq*Math.cos(a),this.Jq*Math.sin(a));this.q.body.ia(new box_2d.b2Vec2(this.Jq*Math.cos(a),this.Jq*Math.sin(a)),this.q.body.h.o)}};l.we=function(){this.Gc(this.gj);this.gj>this.nc&&(this.nc=this.hi=this.gj)};l.Gd=function(){};
...
l.move=function(){if("inactive"==this.mb||"engaged"==this.mb)if("engaged"==this.mb){var a=new box_2d.b2Vec2(this.body.g.position.x-this.Tc.body.g.position.x,this.body.g.position.y-this.Tc.body.g.position.y);a.bb();a.aa(this.yz);this.Tc==this.q&&this.Xc()&&a.aa(this.pD);this.Tc.body.ia(a,this.body.h.o);this.Tc!=this.q&&(this.Tc.open(1500),"tank"==this.Tc.type&&(this.Tc.la["volatile"]=1500))}else null==this.path&&(this.Rd=this.ue),this.Fj()};
function Ud(a){return new box_2d.b2Vec2(a.body.g.position.x+a.xv*H[a.type].I*Math.cos(a.xe),a.body.g.position.y+a.xv*H[a.type].I*Math.sin(a.xe))}l.Le=function(a){--this.en;0>=this.en&&(this.body.tb(a),this.en=this.Bz,this.Za.body.tb(this.Za.xe));this.xe=a};
...
Tb(0,this.body.g.position)||(b=S(this.Za.body.g.position,this.body.g.position),this.Za.body.ia(new box_2d.b2Vec2(this.zv*Math.cos(b),this.zv*Math.sin(b)),this.Za.body.h.o),this.Za.Le(Math.PI+b),R(this.Za.body.g.position,this.body.g.position)<1.1*this.xv&&(this.mb="inactive",this.Gc(this.Xr,!0),this.Xr>this.nc&&(this.nc=this.hi=this.Xr),this.wv=null));else if("engaged"==this.mb)this.Za.body.pj(new box_2d.b2Vec2(-100,-100));else if("retract_ready"==this.mb){b=new box_2d.b2Vec2(this.q.body.g.position.x-this.body.g.position.x,
...
window.impulse_main=function(){box_2d.b2Vec2=m.ba.Math.lg;box_2d.b2AABB=m.v.Go;box_2d.b2BodyDef=m.l.cm;box_2d.b2Body=m.l.ke;box_2d.b2FixtureDef=m.l.im;box_2d.b2Fixture=m.l.hm;box_2d.b2World=m.l.Re;box_2d.b2MassData=m.v.Sa.Wo;box_2d.b2PolygonShape=m.v.Sa.xi;box_2d.b2CircleShape=m.v.Sa.wj;box_2d.b2DebugDraw=m.l.Pe;box_2d.b2MouseJointDef=m.l.J.lm;box_2d.b2ContactListener=m.l.Jo;Kc=1200;Lc=600;X=200;P=Kc-2*X;Q=Lc;Le=document.getElementById("canvas");var a=document.getElementById("canvas_container");Le.width=Kc;Le.height=Lc;a.style.width=Kc+"px";a.style.height=Lc+"px";Me=document.getElementById("bg_canvas");
...
l.reset=function(){Sg(this);this.Qf=this.sw=!1;var a=new box_2d.b2Vec2(0,0);this.sa=new box_2d.b2World(a,!1);Tg(this);a=new box_2d.b2ContactListener;a.Bt=this.wz;a.Tt=this.lz;this.sa.Tx(a);this.jc=0;this.Nb=this.Ii=!1;this.i.reset();!this.i||this instanceof uc||Ug(this);Ne.translate(X,0);this.i.Nf(Ne);Ne.translate(-X,0);this.gk=0;this.Nu=!1;this.ra&&this.Fg&&(this.Tw=new Vg(this),this.Ff={},this.Yn={},this.pB=500);!this.ra&&this.i&&Sc(this);this.Nr=!1};
...
function Tg(a){var b,c;b=[{x:P/G/2,y:2},{x:P/G/2,y:2},{x:2,y:Q/G/2},{x:2,y:Q/G/2}];c=[{x:P/G/2,y:-2},{x:P/G/2,y:Q/G+2},{x:-2,y:Q/G/2},{x:P/G+2,y:Q/G/2}];for(var d=0;4>d;d++){var f=new box_2d.b2FixtureDef;f.filter.rf=1;f.filter.Af=2;var g=new box_2d.b2BodyDef;g.type=box_2d.b2Body.pf;f.shape=new box_2d.b2PolygonShape;f.shape.Qx(b[d].x,b[d].y);g.position.P(c[d].x,c[d].y);a.sa.ko(g).Xq(f)}}l.wz=function(a){var b=a.tc.Gf();a=a.uc.Gf();b&&a&&(b.owner.Se(a.owner,b.body,a.body),a.owner.Se(b.owner,a.body,b.body))};
