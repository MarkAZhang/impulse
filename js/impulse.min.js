...
a;this.ig.vt=this.df&255;this.ig.tt=(this.df&65280)>>8&255;this.ig.ut=(this.df&16711680)>>16&255;this.ig.st=(this.df&4278190080)>>24&255}});u.ar=function(){this.position=new k;this.mh=new k;this.Rf=new k;this.id=new y};w.xk=function(){};w.$s=function(a,b,c){++w.EF;var v=c.Th,r=c.Uh,g=c.CA,x=c.DA,A=w.fE;A.qB(b,v,g,r,x);var H=A.$,h=w.dE,F=w.eE,V=0;A.Ww();for(var m=0,M,qa=0;20>qa;){V=A.Qb;for(m=0;m<V;m++)h[m]=H[m].nd,F[m]=H[m].od;switch(A.Qb){case 1:break;case 2:A.vB();break;case 3:A.wB();break;default:d.gc(!1)}if(3==
A.Qb)break;A.Ww();m=A.iB();if(m.Kq()<Number.MIN_VALUE*Number.MIN_VALUE)break;M=H[A.Qb];M.nd=v.it(f.Zi(g.G,m.Yi()));M.$d=f.Zc(g,v.Pd(M.nd));M.od=r.it(f.Zi(x.G,m));M.Bg=f.Zc(x,r.Pd(M.od));M.u=f.rc(M.Bg,M.$d);++qa;++w.FF;for(var p=!1,m=0;m<V;m++)if(M.nd==h[m]&&M.od==F[m]){p=!0;break}if(p)break;++A.Qb}w.RB=f.ce(w.RB,qa);A.jB(a.Xg,a.Yg);a.Ek=f.rc(a.Xg,a.Yg).bg();a.ZF=qa;A.CB(b);c.NA&&(b=v.Da,r=r.Da,a.Ek>b+r&&a.Ek>Number.MIN_VALUE?(a.Ek-=b+r,c=f.rc(a.Yg,a.Xg),c.bb(),a.Xg.x+=b*c.x,a.Xg.y+=b*c.y,a.Yg.x-=
r*c.x,a.Yg.y-=r*c.y):(M=new k,M.x=.5*(a.Xg.x+a.Yg.x),M.y=.5*(a.Xg.y+a.Yg.y),a.Xg.x=a.Yg.x=M.x,a.Xg.y=a.Yg.y=M.y,a.Ek=0))};n.Ac.push(function(){n.w.xk.fE=new r;n.w.xk.dE=new ba(3);n.w.xk.eE=new ba(3)});K.br=function(){};L.cr=function(){this.Xg=new k;this.Yg=new k};da.dr=function(){};da.prototype.Q=function(f){switch(f.Eb()){case c.Hk:f=f instanceof a?f:null;this.$=new aa(1,!0);this.$[0]=f.pd;this.Qb=1;this.Da=f.Da;break;case c.oj:f=f instanceof b?f:null;this.$=f.$;this.Qb=f.Kb;this.Da=f.Da;break;default:d.gc(!1)}};
...
d.ln=a.ln;f.qt(d);for(M=M=0;M<f.Vd;++M)if(b=f.Gh[M],b.P&=~p.Oc,0!=b.ld()&&b.Eb()==p.Bd)for(b.wx(),c=b.Pb;c;c=c.next)c.Cc.P&=~$.Em;for(M=0;M<f.og;++M)d=f.Zm[M],d.P&=~($.Em|$.Oc);for(M=0;M<f.Qe;++M)d=f.Ug[M],d.bl=!1;this.Pe.Bq()}}};n.Ac.push(function(){n.l.Je.kE=new X;n.l.Je.gG=new c;n.l.Je.cA=new b;n.l.Je.dA=new b;n.l.Je.jE=new X;n.l.Je.cE=new aa;n.l.Je.eG=new f(.5,.8,.8);n.l.Je.zu=1;n.l.Je.yu=2})})();
...
c;++a){f=b[a];d=f.nc;var h=f.oc,r=d.$a.Da,v=h.$a.Da,k=d.dc,m=h.dc,p=f.Qf,u=W.MB(d.nv,h.nv),q=W.NB(d.uv,h.uv),kb=k.p.x,y=k.p.y,w=m.p.x,B=m.p.y,U=k.I,K=m.I;W.gc(0<p.Ic);t.wl.kd(p,k.g,r,m.g,v);h=t.wl.Ra.x;f=t.wl.Ra.y;d=this.Hh[a];d.kb=k;d.ub=m;d.oD=p;d.Rf.x=h;d.Rf.y=f;d.Bf=p.Ic;d.Pm=u;d.rn=q;d.Zr.x=p.Jd.x;d.Zr.y=p.Jd.y;d.Fh.x=p.fb.x;d.Fh.y=p.fb.y;d.bh=r+v;d.type=p.jb;for(r=0;r<d.Bf;++r){u=p.gb[r];v=d.pe[r];v.dd=u.dl;v.di=u.jl;v.Fh.N(u.fb);var u=v.ob.x=t.wl.gb[r].x-k.h.o.x,q=v.ob.y=t.wl.gb[r].y-k.h.o.y,
...
(r=Math.sqrt(r),this.Ra.x=d/r,this.Ra.y=h/r):(this.Ra.x=1,this.Ra.y=0);this.gb[0].x=.5*(b+g);this.gb[0].y=.5*(c+f);this.bs[0]=d*this.Ra.x+h*this.Ra.y-a.bh;break;case pa.Ng:f=a.kb.g.G;d=a.Zr;this.Ra.x=f.j.x*d.x+f.k.x*d.y;this.Ra.y=f.j.y*d.x+f.k.y*d.y;f=a.kb.g.G;d=a.Fh;g=a.kb.g.position.x+(f.j.x*d.x+f.k.x*d.y);h=a.kb.g.position.y+(f.j.y*d.x+f.k.y*d.y);f=a.ub.g.G;for(b=0;b<a.Bf;++b)d=a.pe[b].Fh,c=a.ub.g.position.x+(f.j.x*d.x+f.k.x*d.y),d=a.ub.g.position.y+(f.j.y*d.x+f.k.y*d.y),this.bs[b]=(c-g)*this.Ra.x+
(d-h)*this.Ra.y-a.bh,this.gb[b].x=c,this.gb[b].y=d;break;case pa.Ik:f=a.ub.g.G;d=a.Zr;this.Ra.x=f.j.x*d.x+f.k.x*d.y;this.Ra.y=f.j.y*d.x+f.k.y*d.y;f=a.ub.g.G;d=a.Fh;g=a.ub.g.position.x+(f.j.x*d.x+f.k.x*d.y);h=a.ub.g.position.y+(f.j.y*d.x+f.k.y*d.y);f=a.kb.g.G;for(b=0;b<a.Bf;++b)d=a.pe[b].Fh,c=a.kb.g.position.x+(f.j.x*d.x+f.k.x*d.y),d=a.kb.g.position.y+(f.j.y*d.x+f.k.y*d.y),this.bs[b]=(c-g)*this.Ra.x+(d-h)*this.Ra.y-a.bh,this.gb[b].Q(c,d);this.Ra.x*=-1;this.Ra.y*=-1}};n.Ac.push(function(){n.l.ka.yk.KF=
new C;n.l.ka.yk.LF=new C})})();
(function(){var a=n.aa.Math.mi,b=n.aa.Math.Gf,c=n.aa.Math.gg,d=n.l.Vb.Bt,f=n.l.Vb.Dt,g=n.l.Vb.Et,h=n.l.Vb.Nc,k=n.l.Vb.Kt,m=n.l.Vb.Qt,q=n.l.Vb.$t;n.Gb(d,n.l.Vb.Nc);d.prototype.la=n.l.Vb.Nc.prototype;d.Bt=function(){n.l.Vb.Nc.Nc.apply(this,arguments);this.Rf=new c(0,-1);this.sb=this.offset=0;this.mh=new c(0,0);this.TC=2;this.GB=1;this.$E=!0;this.Ty=null};d.prototype.bj=function(){if(this.Gc){this.$E&&(this.Ty=this.rd.Cz.Db());for(var a=this.Gc;a;a=a.Ve){var b=a.body;if(0!=b.ld()){for(var d=new c,f=
new c,g=0,h=0,k=b.Hc;k;k=k.Ha){var m=new c,q=k.$a.xq(this.Rf,this.offset,b.af(),m),g=g+q;d.x+=q*m.x;d.y+=q*m.y;var B=0,B=1,h=h+q*B;f.x+=q*m.x*B;f.y+=q*m.y*B}d.x/=g;d.y/=g;f.x/=h;f.y/=h;g<Number.MIN_VALUE||(h=this.Ty.Yi(),h.ca(this.sb*g),b.mk(h,f),f=b.hB(d),f.eo(this.mh),f.ca(-this.TC*g),b.mk(f,d),b.WA(-b.Nf/b.Z*g*b.I*this.GB))}}}};n.Gb(f,n.l.Vb.Nc);f.prototype.la=n.l.Vb.Nc.prototype;f.Dt=function(){n.l.Vb.Nc.Nc.apply(this,arguments);this.Fw=new c(0,0)};f.prototype.bj=function(a){a=new c(this.Fw.x*
...
(b=b.g.G,h=this.an.Se,g=b.j.x*h.x+b.k.x*h.y,h=b.j.y*h.x+b.k.y*h.y,b=d.g.G,k=this.ma.x-d.h.W.x,m=this.ma.y-d.h.W.y,p=b.j.x*k+b.k.x*m,m=b.j.y*k+b.k.y*m,k=p*h-m*g,this.mc.Rg.Q(-g,-h),this.mc.vk=-k,q+=d.T+d.fa*k*k);this.hl?(this.mc.wk=-this.zc,q+=this.zc*this.zc*f.fa):(b=c.g.G,h=this.bn.Se,g=b.j.x*h.x+b.k.x*h.y,h=b.j.y*h.x+b.k.y*h.y,b=f.g.G,k=this.xa.x-f.h.W.x,m=this.xa.y-f.h.W.y,p=b.j.x*k+b.k.x*m,m=b.j.y*k+b.k.y*m,k=p*h-m*g,this.mc.Sg.Q(-this.zc*g,-this.zc*h),this.mc.wk=-this.zc*k,q+=this.zc*this.zc*
(f.T+f.fa*k*k));this.Z=0<q?1/q:0;a.Cg?(d.p.x+=d.T*this.t*this.mc.Rg.x,d.p.y+=d.T*this.t*this.mc.Rg.y,d.I+=d.fa*this.t*this.mc.vk,f.p.x+=f.T*this.t*this.mc.Sg.x,f.p.y+=f.T*this.t*this.mc.Sg.y,f.I+=f.fa*this.t*this.mc.wk):this.t=0};p.prototype.cf=function(){var a=this.Ga,b=this.Qa,c=-this.Z*this.mc.aB(a.p,a.I,b.p,b.I);this.t+=c;a.p.x+=a.T*c*this.mc.Rg.x;a.p.y+=a.T*c*this.mc.Rg.y;a.I+=a.fa*c*this.mc.vk;b.p.x+=b.T*c*this.mc.Sg.x;b.p.y+=b.T*c*this.mc.Sg.y;b.I+=b.fa*c*this.mc.wk};p.prototype.bf=function(){var b=
this.Ga,c=this.Qa,d=0,f=0,d=this.gl?this.gl.be():this.an.Wn(),f=this.hl?this.hl.be():this.bn.Wn(),d=-this.Z*(this.Xm-(d+this.zc*f));b.h.o.x+=b.T*d*this.mc.Rg.x;b.h.o.y+=b.T*d*this.mc.Rg.y;b.h.R+=b.fa*d*this.mc.vk;c.h.o.x+=c.T*d*this.mc.Sg.x;c.h.o.y+=c.T*d*this.mc.Sg.y;c.h.R+=c.fa*d*this.mc.wk;b.sc();c.sc();return 0<a.yb};n.Gb(t,n.l.M.va);t.prototype.la=n.l.M.va.prototype;t.Ao=function(){n.l.M.va.va.apply(this,arguments)};t.prototype.Ao=function(){this.la.va.call(this);this.type=u.wy;this.Vk=this.Uk=
null;this.ql=1};y.Rt=function(){this.Rg=new f;this.Sg=new f};y.prototype.La=function(){this.Rg.La();this.vk=0;this.Sg.La();this.wk=0};y.prototype.Q=function(a,b,c,d){void 0===b&&(b=0);void 0===d&&(d=0);this.Rg.N(a);this.vk=b;this.Sg.N(c);this.wk=d};y.prototype.aB=function(a,b,c,d){void 0===b&&(b=0);void 0===d&&(d=0);return this.Rg.x*a.x+this.Rg.y*a.y+this.vk*b+(this.Sg.x*c.x+this.Sg.y*c.y)+this.wk*d};u.ja=function(){this.Ae=new K;this.Be=new K;this.Kh=new f;this.Lh=new f};u.prototype.Eb=function(){return this.jb};
...
(k.y-g.y)+this.Jb*m-this.Ib*h;this.Tg&&this.Wa!=u.xe?(S=this.ea.x*(k.x-g.x)+this.ea.y*(k.y-g.y)+this.Ab*m-this.zb*h,p=this.t.Db(),a=this.ua.sk(new f,-q,-S),this.t.Dg(a),this.Wa==u.xh?this.t.y=d.ce(this.t.y,0):this.Wa==u.Hd&&(this.t.y=d.pk(this.t.y,0)),q=-q-(this.t.y-p.y)*this.ua.k.x,S=0!=this.ua.j.x?q/this.ua.j.x+p.x:p.x,this.t.x=S,a.x=this.t.x-p.x,a.y=this.t.y-p.y,p=a.x*this.Ca.x+a.y*this.ea.x,q=a.x*this.Ca.y+a.y*this.ea.y,S=a.x*this.Ib+a.y*this.zb,t=a.x*this.Jb+a.y*this.Ab):(a=0!=this.ua.j.x?-q/
...
arguments);this.ma=new f;this.xa=new f;this.Se=new f;this.Ii=new f;this.ea=new f;this.Ca=new f;this.ua=new c;this.t=new g};W.prototype.wd=function(){return this.Ga.ag(this.ma)};W.prototype.Wn=function(){var a=this.Ga,b=this.Qa,c=a.ag(this.ma),d=b.ag(this.xa),b=d.x-c.x,c=d.y-c.y,a=a.jt(this.Se);return a.x*b+a.y*c};W.prototype.nh=function(a,b){void 0===a&&(a=0);void 0===b&&(b=0);this.Ga.Qd(!0);this.Qa.Qd(!0);this.Te=a;this.Ue=b};W.prototype.Ho=function(a){this.la.ja.call(this,a);this.ma.N(a.Wc);this.xa.N(a.Xc);
this.Se.N(a.$k);this.Ii.x=-this.Se.y;this.Ii.y=this.Se.x;this.kD=a.Yj;this.t.La();this.nb=this.Ce=0;this.Te=a.iv;this.Ue=a.xw;this.tv=a.xv;this.Kp=a.Pp;this.Tg=a.Hm;this.Lj=a.gp;this.Wa=u.xe;this.ea.La();this.Ca.La()};W.prototype.Ff=function(b){var c=this.Ga,f=this.Qa,g,h=0;this.Kh.N(c.h.W);this.Lh.N(f.h.W);var k=c.af();f.af();g=c.g.G;var m=this.ma.x-this.Kh.x,p=this.ma.y-this.Kh.y,h=g.j.x*m+g.k.x*p,p=g.j.y*m+g.k.y*p,m=h;g=f.g.G;var q=this.xa.x-this.Lh.x,S=this.xa.y-this.Lh.y,h=g.j.x*q+g.k.x*S,S=
...
q*this.Jb*this.Jb;this.ua.j.y=p*this.Ib+q*this.Jb;this.ua.j.z=p*this.Ib*this.zb+q*this.Jb*this.Ab;this.ua.k.x=this.ua.j.y;this.ua.k.y=p+q;this.ua.k.z=p*this.zb+q*this.Ab;this.ua.Fa.x=this.ua.j.z;this.ua.Fa.y=this.ua.k.z;this.ua.Fa.z=k+m+p*this.zb*this.zb+q*this.Ab*this.Ab;this.Tg?(g=this.ea.x*g+this.ea.y*h,d.hd(this.Ue-this.Te)<2*a.yb?this.Wa=u.nj:g<=this.Te?this.Wa!=u.xh&&(this.Wa=u.xh,this.t.z=0):g>=this.Ue?this.Wa!=u.Hd&&(this.Wa=u.Hd,this.t.z=0):(this.Wa=u.xe,this.t.z=0)):this.Wa=u.xe;0==this.Lj&&
...
u.nj&&(y=this.Ce*(this.Kp-(this.ea.x*(m.x-h.x)+this.ea.y*(m.y-h.y)+this.Ab*p-this.zb*k)),q=this.nb,a=a.Ua*this.tv,this.nb=d.Cb(this.nb+y,-a,a),y=this.nb-q,q=y*this.ea.x,t=y*this.ea.y,S=y*this.zb,y*=this.Ab,h.x-=this.xc*q,h.y-=this.xc*t,k-=this.me*S,m.x+=this.yc*q,m.y+=this.yc*t,p+=this.ne*y);S=this.Ca.x*(m.x-h.x)+this.Ca.y*(m.y-h.y)+this.Jb*p-this.Ib*k;t=p-k;this.Tg&&this.Wa!=u.xe?(a=this.ea.x*(m.x-h.x)+this.ea.y*(m.y-h.y)+this.Ab*p-this.zb*k,q=this.t.Db(),a=this.ua.co(new g,-S,-t,-a),this.t.Dg(a),
this.Wa==u.xh?this.t.z=d.ce(this.t.z,0):this.Wa==u.Hd&&(this.t.z=d.pk(this.t.z,0)),S=-S-(this.t.z-q.z)*this.ua.Fa.x,t=-t-(this.t.z-q.z)*this.ua.Fa.y,t=this.ua.Pl(new f,S,t),t.x+=q.x,t.y+=q.y,this.t.x=t.x,this.t.y=t.y,a.x=this.t.x-q.x,a.y=this.t.y-q.y,a.z=this.t.z-q.z,q=a.x*this.Ca.x+a.z*this.ea.x,t=a.x*this.Ca.y+a.z*this.ea.y,S=a.x*this.Ib+a.y+a.z*this.zb,y=a.x*this.Jb+a.y+a.z*this.Ab):(a=this.ua.Pl(new f,-S,-t),this.t.x+=a.x,this.t.y+=a.y,q=a.x*this.Ca.x,t=a.x*this.Ca.y,S=a.x*this.Ib+a.y,y=a.x*this.Jb+
a.y);h.x-=this.xc*q;h.y-=this.xc*t;k-=this.me*S;m.x+=this.yc*q;m.y+=this.yc*t;p+=this.ne*y;b.p.N(h);b.I=k;c.p.N(m);c.I=p};W.prototype.bf=function(){var c=this.Ga,h=this.Qa,k=c.h.o,m=c.h.R,p=h.h.o,q=h.h.R,F,u=0,t=0,S=0,y=0,w=0,t=!1,B=0,C=b.Cq(m),K=b.Cq(q);F=C;var w=this.ma.x-this.Kh.x,L=this.ma.y-this.Kh.y,u=F.j.x*w+F.k.x*L,L=F.j.y*w+F.k.y*L,w=u;F=K;K=this.xa.x-this.Lh.x;S=this.xa.y-this.Lh.y;u=F.j.x*K+F.k.x*S;S=F.j.y*K+F.k.y*S;K=u;F=p.x+K-k.x-w;u=p.y+S-k.y-L;if(this.Tg){this.ea=d.yd(C,this.Se);this.zb=
...
new b;this.md=new g;this.Og=new f;this.Yh=new f;this.ma=new f;this.xa=new f;this.t=new g;this.Z=new c};$.prototype.wd=function(){return this.Ga.ag(this.ma)};$.prototype.be=function(){return this.Qa.h.R-this.Ga.h.R-this.Np};$.prototype.nh=function(a,b){void 0===a&&(a=0);void 0===b&&(b=0);this.Jp=a;this.cs=b};$.prototype.bm=function(a){this.la.ja.call(this,a);this.ma.N(a.Wc);this.xa.N(a.Xc);this.Np=a.Yj;this.t.La();this.nb=0;this.Jp=a.uz;this.cs=a.LA;this.iD=a.pD;this.Kp=a.Pp;this.Tg=a.Hm;this.Lj=a.gp;
...
w);0==this.Lj&&(this.nb=0);if(this.Tg){var y=f.h.R-c.h.R-this.Np;d.hd(this.cs-this.Jp)<2*a.zk?this.Wa=u.nj:y<=this.Jp?(this.Wa!=u.xh&&(this.t.z=0),this.Wa=u.xh):y>=this.cs?(this.Wa!=u.Hd&&(this.t.z=0),this.Wa=u.Hd):(this.Wa=u.xe,this.t.z=0)}else this.Wa=u.xe;b.Cg?(this.t.x*=b.Dc,this.t.y*=b.Dc,this.nb*=b.Dc,b=this.t.x,y=this.t.y,c.p.x-=g*b,c.p.y-=g*y,c.I-=t*(k*y-m*b+this.nb+this.t.z),f.p.x+=h*b,f.p.y+=h*y,f.I+=w*(p*y-q*b+this.nb+this.t.z)):(this.t.La(),this.nb=0)};$.prototype.cf=function(a){var b=
this.Ga,c=this.Qa,f=0,g=0,h=0,k=0,m=0,p=b.p,q=b.I,t=c.p,w=c.I,y=b.T,C=c.T,B=b.fa,K=c.fa;this.Lj&&this.Wa!=u.nj&&(g=this.Ce*-(w-q-this.Kp),h=this.nb,k=a.Ua*this.iD,this.nb=d.Cb(this.nb+g,-k,k),g=this.nb-h,q-=B*g,w+=K*g);if(this.Tg&&this.Wa!=u.xe){a=b.g.G;g=this.ma.x-b.h.W.x;h=this.ma.y-b.h.W.y;f=a.j.x*g+a.k.x*h;h=a.j.y*g+a.k.y*h;g=f;a=c.g.G;k=this.xa.x-c.h.W.x;m=this.xa.y-c.h.W.y;f=a.j.x*k+a.k.x*m;m=a.j.y*k+a.k.y*m;k=f;a=t.x+-w*m-p.x- -q*h;var L=t.y+w*k-p.y-q*g;this.Z.co(this.md,-a,-L,-(w-q));this.Wa==
u.nj?this.t.Dg(this.md):this.Wa==u.xh?(f=this.t.z+this.md.z,0>f&&(this.Z.Pl(this.Yh,-a,-L),this.md.x=this.Yh.x,this.md.y=this.Yh.y,this.md.z=-this.t.z,this.t.x+=this.Yh.x,this.t.y+=this.Yh.y,this.t.z=0)):this.Wa==u.Hd&&(f=this.t.z+this.md.z,0<f&&(this.Z.Pl(this.Yh,-a,-L),this.md.x=this.Yh.x,this.md.y=this.Yh.y,this.md.z=-this.t.z,this.t.x+=this.Yh.x,this.t.y+=this.Yh.y,this.t.z=0));p.x-=y*this.md.x;p.y-=y*this.md.y;q-=B*(g*this.md.y-h*this.md.x+this.md.z);t.x+=C*this.md.x;t.y+=C*this.md.y;w+=K*(k*
...
function cc(a,b){null!=a.cc&&a.cc!=b?a.Lc[a.cc].OC()?bc(a,b):(a.Wj[a.cc]=!1,a.Wj[b]=!0,a.Lc[a.cc].Hy(500,function(){bc(a,b)})):(b in a.Lc||(b in ka?(a.Lc[b]=new ha("audio/"+b+".ogg"),a.Lc[b].bind("ended",function(){this.setTime(ka[b]);this.play()})):a.Lc[b]=new ha("audio/"+b+".ogg",{loop:!0})),a.Mi?a.Lc[b].dh(0):a.Lc[b].dh(D.im),a.Lc[b].play(),a.Wj[b]=!0,a.cc=b)}
function dc(){var a=ac;if(a.cc){a.Wj[a.cc]=!1;var b=a.cc;a.Lc[a.cc].Hy(300,function(){a.cc&&!a.Wj[a.cc]?(a.Lc[a.cc].stop(),a.cc=null):a.cc==b&&a.Wj[a.cc]&&a.Lc[a.cc].dh(D.im)})}};function ec(a,b){void 0!==a&&(this.Id=fc()-1,this.Wf=0,this.ik=gc(),this.Kg=0,this.ai=hc(),this.Zy=!1,this.hc=b,0<a&&(this.ci=1E3*Db["blitz_hive"+a].oq),this.hc||(this.Id=0,1<this.ik&&(this.ik=1)),this.jh={},this.lz=this.Id,this.mz=0,this.pz=fc(),this.KA=gc(),this.Bk=null,this.H={},this.qa=a,this.Sr=0==this.qa?"TUTORIAL":"HIVE "+oa[a],this.eu=oa[a],this.HD=0,this.gi=null)}ec.prototype.clone=function(a){var b=new ec,c;for(c in a)b[c]=a[c];return b};
function ic(a){a.Id+=fc()-a.pz;a.ik+=gc()-a.KA;a.ai=hc();a.pz=fc();a.KA=gc()}ec.prototype.continue=function(){this.Id=fc();this.Wf=0;this.ik=gc();this.ai=hc();this.lz=this.Id;this.mz=0;this.Kg+=1};function jc(a,b,c,d){this.ia(a,b,c,d)}l=jc.prototype;l.wa=3.5;l.id=9999;l.Fn=1.2;l.bz=50;l.Pg=10;l.Xu=.03125;l.IC=z.impulse_target_blue;l.az=z.impulse_blue;l.sb=.5625;l.bh=.66;l.K=.66;
l.ia=function(a,b,c,d){if(null!=a){"easy"==J&&(this.sb*=1.5,this.Fn*=1.5);var f=new b2FixtureDef;f.sb=this.sb;f.Pm=0;f.rn=1;f.filter.lf=2;f.filter.yf=29;var g=new b2BodyDef;g.type=b2Body.Bd;f.shape=new b2CircleShape(jc.prototype.bh);this.Y=jc.prototype.bh;this.i=d.i;this.v=d;g.position.x=b;g.position.y=c;g.Wr=this.wa;this.body=a.Rn(g);this.body.yq(f).ao({owner:this,body:this.body,self:this});this.shape=f.shape;this.Zg=[];for(a=0;4>a;a++)this.Zg.push({Y:.5,ii:a*Math.PI/2});this.qq=this.bp=this.right=
this.left=!1;this.hk=this.Eh=this.zh=this.Ch=this.Ah=null;this.xi=0;this.hp=[];this.tw=[];this.gj=!1;this.oh={};this.ad=0;this.fj=500;this.ej=0;this.hk=!1;this.kh={};this.Hn=1E3;this.Fl=0;this.uw=20;this.ZE=250;this.ck=this.fd=this.ou=this.sm=0;this.Bv={x:0,y:0};this.status="normal";this.r=[0,0,0,0,0,0];this.fh=.3;this.O=!1;this.cb=1E3;this.tb=0;this.color=z.player_color;this.oa=this.Fn;this.Vx=5;this.hu=!1;this.Mf=1.5;this.dv=0;this.Qp=!1;this.xt=250;this.yt=!0;this.ko=this.xt}};
function kc(a,b){switch(b){case ua.Jq:a.left=!0;break;case ua.Mq:a.right=!0;break;case ua.zq:a.bp=!0;break;case ua.Oq:a.qq=!0;break;case ua.$i:case ua.qk:a.qq=!1;a.bp=!1;a.left=!1;a.right=!1;a.Ah=null;a.Ch=null;a.Eh=null;a.zh=null;break;case ua.ax:a.Ah=(new Date).getTime();break;case ua.cx:a.Eh=(new Date).getTime();break;case ua.bx:a.Ch=(new Date).getTime();break;case ua.$w:a.zh=(new Date).getTime()}}l.Ti=function(a){this.r[0]=Math.max(a,this.r[0]);this.r[1]=Math.max(a,this.r[1])};
...
(this.gj=!0,this.v.H.Yu=!0,this.oh=this.body.g.position.Db(),this.ad=this.xi,this.ej=this.fj,$b("impulse"),this.v instanceof nc&&(c=this.v,1==c.da&&"first_time_tutorial"==c.mode&&0==c.Rd&&"none"==c.ib&&(c.eg=c.zm,c.Rd=!0)),this.v.eh&&oc(this.v,"player_impulsed")),this.xi=R({x:this.body.g.position.x*E,y:this.body.g.position.y*E},this.Bv)):"keyboard"==D.uc&&!this.gj&&0>=this.r[1]&&(c=0,null!=this.Ah&&this.Ah>c&&(c=this.Ah),null!=this.Ch&&this.Ch>c&&(c=this.Ch),null!=this.Eh&&this.Eh>c&&(c=this.Eh),
null!=this.zh&&this.zh>c&&(c=this.zh),0!=c&&40<(new Date).getTime()-c&&(null!=this.Ah&&null!=this.Eh?this.ad=5*Math.PI/4:null!=this.Ah&&null!=this.zh?this.ad=3*Math.PI/4:null!=this.Ch&&null!=this.Eh?this.ad=7*Math.PI/4:null!=this.Ch&&null!=this.zh?this.ad=1*Math.PI/4:null!=this.Ah?this.ad=Math.PI:null!=this.Ch?this.ad=0:null!=this.Eh?this.ad=3*Math.PI/2:null!=this.zh&&(this.ad=1*Math.PI/2),0<this.r[4]&&(this.ad+=Math.PI),this.gj=!0,this.v.H.Yu=!0,this.oh=this.body.g.position.Db(),this.ej=this.fj,
...
R(this.oh,b[d]);this.hp.push(this.i.s[c].id);this.i.s[c].Cf(this.oh,this.bz,f);break}this.i.s[c]instanceof tc&&"engaged"==this.i.s[c].mb&&uc(this.i.s[c])}if(this.i.s[c]instanceof tc&&"inactive"!=this.i.s[c].mb){var g=this.i.s[c].Ya;if(-1==this.hp.indexOf(g.id))for(b=g.Aj(),d=0;d<b.length;d++)rc(this,b[d])&&sc(this,b[d],!0)&&(f=R(this.oh,b[d]),g.Cf(this.oh,this.bz,f),this.hp.push(g.id))}}this.ej-=a}this.hk&&(0>this.Fl?(vc(this,!0),this.hk=!1,this.tw=[],this.v instanceof nc&&(a=this.v,1==a.da&&"ult_tutorial"==
a.mode&&0==a.Rd&&"none"==a.ib&&(a.eg=a.zm,a.Rd=!0)),this.i.pa&&this.body.aj(this.kh)):(vc(this,!1),this.Fl-=a));0>=this.r[0]&&(b=this.oa,c=a=0,this.left&&--a,this.right&&(a+=1),this.qq&&--c,this.bp&&(c+=1),b=2==Math.abs(a)+Math.abs(c)?b/Math.sqrt(2):b,0<this.r[4]&&(a*=-1,c*=-1),this.body.ha(new b2Vec2(b*a,b*c),this.body.h.o),this.v instanceof nc&&(0!=a||0!=c)&&(b=this.v,0==b.da&&"first_time_tutorial"==b.mode&&0==b.Rd&&"none"==b.ib&&(b.eg=b.zm,b.Rd=!0)),!this.v.eh||0==a&&0==c||oc(this.v,"player_moved"))}};
function mc(a){a.oa=0<a.r[5]?a.Fn*a.Vx:0<a.r[3]?a.Fn/a.Mf/a.Mf:a.Fn}
function vc(a,b){for(var c=0;c<a.i.s.length;c++){var d=a.i.s[c];if(!d.O){for(var f=d.Aj(),g=(b?1:.002)*a.ZE,h=0;h<f.length;h++)if(wc(a,f[h])){var k=R(a.kh,f[h]);-1==a.tw.indexOf(d.id)?(a.tw.push(d.id),xc(d,!0)):xc(d,!1);f=G[d.type];h=d.wf?.02/d.Bh:1;"slingshot"==d.type&&(h*=2);d.Cf(a.kh,1*g*h*d.body.Z*f.wa,k,!0);break}d instanceof tc&&"engaged"==d.mb&&d.Pc==a&&uc(d)}if(d instanceof tc&&"inactive"!=d.mb)for(d=d.Ya,f=d.Aj(),h=0;h<f.length;h++)wc(a,f[h])&&(k=R(a.kh,f[h]),d.Cf(a.kh,2*g,k))}}
function yc(a){return a.hk?a.kh:a.body.g.position}function rc(a,b){var c=R(a.oh,b);return a.ad<2*-Math.PI/3?c<=a.ad+Math.PI/3||c>=a.ad+5*Math.PI/3:a.ad>2*Math.PI/3?c<=a.ad-5*Math.PI/3||c>=a.ad-Math.PI/3:c>=a.ad-Math.PI/3&&c<=a.ad+Math.PI/3}function sc(a,b,c){var d=zc(a),f=a.oh.Db();f.eo(b);f=f.bb();b=c?4*a.Xu:2*a.Xu;return f>=a.Pg*d*((a.fj-a.ej)/a.fj-b)&&f<=a.Pg*d*((a.fj-a.ej)/a.fj+b)}function wc(a,b){var c=a.kh.Db();c.eo(b);c=c.bb();return c<=a.uw*Vb(.15,.5,(a.Hn-a.Fl)/a.Hn)}
function Ac(a,b){b.save();if(a.O){var c=a.O?Math.min((a.cb-a.tb)/a.cb,1):0;b.globalAlpha*=1-c}a.hk&&0<a.Fl&&(b.save(),b.globalAlpha*=.3,c=Math.min(2-Math.abs((a.Fl-a.Hn/2)/(a.Hn/4)),1),b.globalAlpha*=c/2,b.fillStyle="white",b.fillRect(0,0,Bc,Cc),b.restore(),b.shadowBlur=10,b.shadowColor="#ccc",b.globalAlpha*=.5,c=Vb(.1,.5,(a.Hn-a.Fl)/a.Hn),.4<c&&(b.globalAlpha*=0>(1-c)/.4?0:(1-c)/.4),I(b,a.kh.x*E,a.kh.y*E,0,a.uw*c*E*2,a.uw*c*E*2,"generated_ultimate",va));b.restore()}
l.ah=function(a){this.O||Ac(this,a)};
l.X=function(a){if(!this.O){Ac(this,a);a.save();if(0<this.sm){var b=Math.max((this.ou-this.sm)/this.ou,0);za(a,this.body.g.position.x,this.body.g.position.y,this.bh,b,"#24ac40")}else 0<this.fd&&(b=Math.max((this.ck-this.fd)/this.ck,0),za(a,this.body.g.position.x,this.body.g.position.y,this.bh,b,"gray"));if(this.yt){var b=this.ko/this.xt,c=1+8*b;a.save();a.globalAlpha*=1-b;a.beginPath();a.lineWidth=Math.ceil(4-4*b);a.strokeStyle=z.impulse_blue;a.arc(this.body.g.position.x*E,this.body.g.position.y*
E,this.shape.Da*c*E,0,2*Math.PI,!0);a.stroke();a.restore()}else this.hk?(c=zc(this),I(a,this.kh.x*E,this.kh.y*E,this.body.ga(),this.shape.Da*E*2.5*c,this.shape.Da*E*2.5*c,"player_gray")):0<this.r[0]?Dc(this,a,"player_red"):0<this.r[4]?Dc(this,a,"player_green"):0<this.r[1]?Dc(this,a,"player_gray"):0<this.r[2]?Dc(this,a,"player_yellow"):Dc(this,a,"player_normal");c=zc(this);0<this.r[3]&&(a.beginPath(),a.arc(this.body.g.position.x*E,this.body.g.position.y*E,this.bh*c*E,0,2*Math.PI,!1),a.strokeStyle=
"black",a.stroke());a.beginPath();D.Tr&&(a.save(),b=this.ko/this.xt,a.globalAlpha*=Math.max(0,1-b),0>=this.r[1]&&"mouse"==D.uc?(a.fillStyle=this.IC,a.arc(this.body.g.position.x*E,this.body.g.position.y*E,this.Pg*c*E,this.xi-Math.PI/3,this.xi+Math.PI/3),a.lineTo(this.body.g.position.x*E+Math.cos(this.xi+Math.PI/3)*this.Pg*c*E,this.body.g.position.y*E+Math.sin(this.xi+Math.PI/3)*this.Pg*c*E),a.lineTo(this.body.g.position.x*E,this.body.g.position.y*E),a.fill()):0>=this.r[1]&&"keyboard"==D.uc&&(a.beginPath(),
a.arc(this.body.g.position.x*E,this.body.g.position.y*E,this.Pg*c*E,0,2*Math.PI),a.globalAlpha/=6,a.lineWidth=2,a.strokeStyle=z.impulse_blue,a.stroke()),a.restore());this.gj&&(a.beginPath(),a.shadowOffsetX=0,a.shadowOffsetY=0,a.shadowBlur=10,a.shadowColor=this.az,a.lineWidth=this.Pg*this.Xu*E*c,b=(this.fj-this.ej)/this.fj,a.save(),.5<b&&(a.globalAlpha*=0>(1-b)/.5?0:(1-b)/.5),a.arc(this.oh.x*E,this.oh.y*E,this.Pg*c*b*E,this.ad-Math.PI/3,this.ad+Math.PI/3),a.strokeStyle=this.az,a.lineWidth=5,a.stroke(),
...
l.Mu=function(a,b){for(var c=this.Zg.length-1,d=null,f=null,g=0;g<this.Zg.length;g++){var h=Kb({x:this.body.g.position.x+this.Zg[g].Y*Math.cos(this.Zg[g].ii+0),y:this.body.g.position.y+this.Zg[g].Y*Math.sin(this.Zg[g].ii+0)},{x:this.body.g.position.x+this.Zg[c].Y*Math.cos(this.Zg[c].ii+0),y:this.body.g.position.y+this.Zg[c].Y*Math.sin(this.Zg[c].ii+0)},a,b);if(null!=h){c=Q(h,a);if(null==f||c<f)d=h,f=c;c=g}}return{KD:d,Td:f}};function Fa(){}l=Fa.prototype;l.Km=1.5;
...
this.yf:30;a.shape=b;this.body&&this.body.yq(a).ao({owner:this,body:this.body,self:this});this.vE.push(b);b instanceof b2PolygonShape?this.wg.push(b.$):this.wg.push(null)}this.Kf=!0;Fc(this);this.path=null;this.Dw=0;this.Cw=!1;this.id=d;this.Dk=this.O=!1;this.cb=this.jy=500;this.tb=0;this.r=[0,0,0,0];this.ra={};this.ra.open=0;this.ra.impulsed=0;this.hz=!0;this.Sc=!1;this.xA=0;this.ap=!0;this.Ld=this.oe=40;this.hF=10;this.fh=.3;this.Gd=!1;this.lj=!0;this.dw=this.oa/3;this.$u=!1;this.av=this.cz=2E3;
this.we=2;this.Ur=0;this.QE="normal impulsed stunned silenced gooed lighten ulted white world1 world2 world3 world4 black".split(" ");this.Sq=[];this.Uq=0;this.DB=4;this.Tq=null;this.io=.5;this.ho=!0;this.Rm=!1;this.nm=0;this.Pz=this.$y=this.Mm=!1;this.Yy=4;this.Sm=0;this.se=null;this.$h&&(this.qf=!1,this.Bc=this.Xh=this.yh=this.hg)};
l.nr=function(){for(var a=0;a<this.i.Yd.length;a++)if(Ib(this.i.Yd[a],this.body.g.position)){if(0>=this.ra.open&&this.Pz){this.body.aj(this.ID);break}0>=this.ra.open&&this.sl?this.Mc("accident"):(this.v instanceof nc&&(a=this.v,3==a.da&&"first_time_tutorial"==a.mode&&0==a.Rd&&"none"==a.ib&&(a.eg=a.zm,a.Rd=!0),4==a.da&&"first_time_tutorial"==a.mode&&0==a.Rd&&"none"==a.ib&&(a.eg=a.zm,a.Rd=!0)),this.v.eh&&oc(this.v,"enemy_killed"),this.Mc("kill"));break}};
...
l.Ke=function(a){this.O||a===this.q&&Lc(this.v)};l.Cf=function(a,b,c){this.qb&&(this.body.ha(new b2Vec2(this.Bh*b*Math.cos(c),this.Bh*b*Math.sin(c)),this.body.h.o),this.qe(a,b,c))};
...
function Vc(a,b,c,d,f){this.type="first boss";this.qa=a;this.ia(a,b,c,d,f);this.Sc=!1;this.we=5;this.xg=this.Kc=562.5;this.Gd=!1;this.Zh=!0;this.Kc=3E3;this.lA=2;this.Zk=9E3;this.Ud=this.Zk-1;this.Ci=4E3;this.qb=this.Ap=!1;this.Jm=["stunner","spear","tank"];this.An={stunner:5,spear:3,tank:20};this.Kf=!1;this.body.rb(Math.PI/2);this.dz=Math.PI/2;this.visibility=0;this.GA=1E3;"easy"==J&&(this.GA=1500);this.Bh="easy"==J?20:15;this.FA=5E3;this.body.re(100*G[this.type].wa);this.Hf=30;"easy"==J&&(this.Hf=
...
{left:0,right:0};this.ps=13;this.nn={left:0,right:0};this.pl=this.Rv=13500;this.pn=2E3;this.Sv=200;this.Zz=8;this.on=15;this.qs=150;this.OD=!1;this.Mz=1E4;this.Kz=12E3;this.Lz=6E3;this.ml=this.Mz/2;this.en=this.Kz;this.sl=!1;this.sz=1E3;this.jw=this.Bp=0;this.Ny=!0}
...
"punching",this.eb.ll.nh(0,Math.PI),this.eb.lu.nh(-Math.PI,Math.PI),this.eb.lh.nh(0,0));"right"==c&&(this.ug.rl=this.eb.rl.be(),this.ug.ru=this.eb.ru.be(),this.ug.rh=this.eb.rh.be(),this.tc[c]="punching",this.eb.rl.nh(-Math.PI,0),this.eb.ru.nh(-Math.PI,Math.PI),this.eb.rh.nh(0,0))}else cd(this);"default"==this.tc[arm]&&(this.body.rb(b),0>this.ef[arm]?0<this.Vj[arm]?this.Vj[arm]-=a:Xc(this,yc(this.q)):cd(this));"delay_default"==this.tc[arm]&&(this.body.rb(b),this.ef[arm]<-this.VD?0<this.Vj[arm]?this.Vj[arm]-=
a:Xc(this,yc(this.q)):cd(this));if("punching"==this.tc[arm])if(0>this.ef[arm]){c=arm;this.tc[c]="paralyzed";if("right"==c)var d=["rl","ru","rh"];"left"==c&&(d=["ll","lu","lh"]);c=void 0;for(c in d){var f=d[c];this.eb[f].nh(this.eb[f].be(),this.eb[f].be())}this.ef[arm]=this.Sz}else{c=arm;if("left"==c){var f=R(this.Ma.lh.g.position,this.Vh[c]),f=new b2Vec2(Math.cos(f),Math.sin(f)),g=Q(this.Ma.lh.g.position,this.Vh[c]);this.eb.lu.wd();10>g&&f.ca(g/10);"punching"==this.tc[c]&&f.ca(this.Yz);this.Ma.lh.ha(f,
...
function cd(a){var b=arm,c=[];"left"==b&&(c=["lu","ll","lh"]);"right"==b&&(c=["ru","rl","rh"]);for(index in c){var d=c[index];if("undefined"!==typeof a.Wk[d].start&&"undefined"!==typeof a.Wk[d].end){var f=Math.max(a.ef[b]/a.kz[b],0),g=null,g="function"==typeof a.Wk[d].end?a.Wk[d].end():a.Wk[d].end,f=f*a.Wk[d].start+(1-f)*g;a.eb[d].nh(f,f)}}}
...
l.ah=function(a,b){if(!(0==this.qb&&this.jc>.9*this.gd)){a.save();if(this.O){var c=this.O?Math.min((this.cb-this.tb)/this.cb,1):0;a.globalAlpha*=1-c}else a.globalAlpha*=this.visibility?this.visibility:1;this.Fk(a,b);c=this.body.g.position;a.globalAlpha*=.6;0<this.lc?I(a,c.x*b,c.y*b,Math.PI/4,173,173,"immunitas_aura_red",tb):I(a,c.x*b,c.y*b,Math.PI/4,173,173,"immunitas_aura",tb);a.globalAlpha/=.6;0<=this.Ud&&this.sy(a,b);a.globalAlpha*=.8;0>this.Ud&&this.Ud>=-this.Ci&&(c=Math.min(5-Math.abs((-this.Ud-
...
function hd(a,b,c,d,f){this.type="third boss";this.ia(a,b,c,d,f);this.Sc=!1;this.we=5;this.Kc=1500;this.xg=5;this.Gd=!1;this.Zh=!0;this.qb=!1;this.body.rb(7*Math.PI/16);this.lc=this.visibility=0;this.vp=150;this.Hf=200;"easy"==J&&(this.Hf=120);this.qc=16;this.fc={};this.ek=2200;"easy"==J&&(this.ek=2800);this.nq=1500;"easy"==J&&(this.nq=2E3);this.Xf=this.nq;this.mw=.7;this.Kf=!1;this.hh=16*this.ek*(1-this.mw);this.Rs=4E3;"easy"==J&&(this.Rs=6E3);this.Mn=this.Rs;this.eF=16;this.ae=0;this.Ub="gap";this.$f=
...
l.Uc=function(a){if(0<this.jc)this.jc=Math.max(this.jc-a,0),this.visibility=1-this.jc/this.gd;else{0==this.qb&&(this.qb=!0,this.visibility=1,this.body.re(G[this.type].wa));this.sn&&(0==this.vl%2?this.body.rb(this.body.ga()+2*Math.PI*a/this.hh):1==this.vl%2&&this.body.rb(this.body.ga()-2*Math.PI*a/this.hh));if("normal"==J){if(0>this.Fe&&!this.Pi&&"activate"!=this.Ub&&"fadeout"!=this.Ub&&"gap"!=this.Ub){this.Fe=0;this.Pi=!0;this.q.$b(Math.round(this.fd));for(var b=0;b<this.i.s.length;b++)this.i.s[b].id!=
...
l.ah=function(a,b){if(!(0==this.qb&&this.jc>.9*this.gd)){a.save();var c=this.O?Math.min((this.cb-this.tb)/this.cb,1):0;a.globalAlpha=this.O?a.globalAlpha*(1-c):a.globalAlpha*(null!=this.visibility?this.visibility:1);this.Pi&&0>this.Fe&&this.Fe>=-this.fd&&(a.save(),c=Math.min(5-Math.abs((-this.Fe-this.fd/2)/(this.fd/10)),1),a.globalAlpha*=c/2,a.fillStyle=this.color,a.fillRect(0,0,Bc,Cc),a.restore());this.Fk(a,b);this.Pi||(a.globalAlpha*=.4);for(c=0;16>c;c++){var d=this.body.g.position,f=2*Math.PI*
...
.5*Math.PI);"troll"==a&&.7>Math.random()&&(b+=Math.random()*Math.PI*.8-.4*Math.PI);"harpoon"==a&&(b+=Math.random()*Math.PI/10-Math.PI/20);var d=new b2Vec2(Math.cos(b),Math.sin(b));d.ca(this.An[a]);c.body.ha(d,c.body.h.o);c.body.rb(b);c.Ld=2*c.oe;c.hg=0;c.yh=0;"harpoon"==a&&c.$b(500,!0)};
...
function qd(a,b,c,d,f){this.type="second boss";this.ia(a,b,c,d,f);this.Sc=!1;this.we=5;this.Gd=!1;this.tf=[];this.jg=this.Pk=1E3;this.Mr=2E3;this.Nr=8;this.Zh=!0;this.ji=3*Math.PI/4;this.Xq=3*Math.PI/16;"easy"==J&&(this.Xq=5*Math.PI/32);this.IB=1*Math.PI/2;this.ki=this.Xq;this.Gx=1*Math.PI/8;this.Wq=50;this.Fx=.9;this.qc=4;this.fo=[];this.Dx=15E3;this.qb=!1;this.body.rb(this.ji);this.Kf=!1;this.hh=this.Dx;this.visibility=0;this.Ro=13400;this.Cd=this.Ro-1;this.Ak=2E3;this.jm=0;this.Sx=10;this.$B=1;
this.So=1E3;this.Qo=.7;this.bu=!1;this.vp=150;this.Wg=this.lc=0;this.body.re(2*G[this.type].wa);this.Dj=2.5;this.ng=4;this.cu=.75;this.Uo=.3;this.km=1.2;"easy"==J&&(this.cu*=1.5,this.Uo*=1.5,this.km*=1.5);this.uA=!1;this.Bl=[];this.Hb=this.lg=1;this.EA=.2;this.Uy=.125;this.wE=.025;this.Bu=1E4;"easy"==J&&(this.Bu=12E3);this.jp=2E3;this.Is=[["stunner","mote"],["harpoon","spear"],["tank","goo"]];this.Au={stunner:.4,spear:.4,tank:2,mote:.2,goo:2.5,harpoon:2};this.Nv=!1;this.ip=[];this.zl=0}
...
l.ah=function(a,b){if(!(0==this.qb&&this.jc>.9*this.gd)){a.save();if(this.O){var c=this.O?Math.min((this.cb-this.tb)/this.cb,1):0;a.globalAlpha*=1-c}else a.globalAlpha*=this.visibility?this.visibility:1;0>this.Cd&&this.Cd>=-this.Ak&&(a.globalAlpha*=.5,c=Math.min(5-Math.abs((-this.Cd-this.Ak/2)/(this.Ak/10)),1),a.globalAlpha*=c/2,a.fillStyle=this.color,a.fillRect(0,0,Bc,Cc),a.globalAlpha*=2);this.Dm(a,b);0>this.Cd&&this.Cd>=-this.Ak&&(c=this.body.g.position,I(a,c.x*b,c.y*b,0,this.jm*b*2,this.jm*b*
...
(f.y+Math.sin(g)*this.K*this.Hb*this.ng*1.5)*b,g+Math.PI/2,50,80,"consumendi_small_arrow",ub);a.restore()}a.restore();f=yc(this.q);c=R(f,this.body.g.position);this.q.O||(.3<=this.Wg&&I(a,(f.x+2*Math.cos(c))*b,(f.y+2*Math.sin(c))*b,c-Math.PI/2,20,10,"consumendi_small_arrow",ub),.75<=this.Wg&&I(a,(f.x+2.75*Math.cos(c))*b,(f.y+2.75*Math.sin(c))*b,c-Math.PI/2,20,10,"consumendi_small_arrow",ub),1.2<=this.Wg&&I(a,(f.x+3.5*Math.cos(c))*b,(f.y+3.5*Math.sin(c))*b,c-Math.PI/2,20,10,"consumendi_small_arrow",
ub),2<=this.Wg&&I(a,(f.x+4.25*Math.cos(c))*b,(f.y+4.25*Math.sin(c))*b,c-Math.PI/2,20,10,"consumendi_small_arrow",ub))};
...
l.ah=function(a,b){if(0>=this.r[1]){var c=this.O?Math.min((this.cb-this.tb)/this.cb,1):0;a.save();a.globalAlpha*=1-c;var d=wd(this);if(this.xg<=this.Kc*this.Vq&&null!=this.sd){c=1-this.xg/(this.Kc*this.Vq);a.save();a.beginPath();a.globalAlpha*=Math.max(c,.2);a.moveTo(d[1].x*b,d[1].y*b);a.lineTo(d[2].x*b,d[2].y*b);a.moveTo(d[3].x*b,d[3].y*b);a.lineTo(d[0].x*b,d[0].y*b);a.lineWidth=1;a.strokeStyle=this.color;a.stroke();if(this.vi<this.Nk){c=this.vi>this.Nk/2?this.Nk-this.vi:this.vi;c/=this.Nk/2;a.globalAlpha*=
...
l.Pj=function(a){Pb(-3,this.body.g.position)||a.ca(this.sj);for(var b=!1,c=0;c<this.i.Yd.length;c++)Ib(this.i.Yd[c],this.body.g.position)&&(b=!0);b?a.ca(this.dw):(0<this.r[1]&&a.ca(.5),0<this.r[2]&&a.ca(this.fh),a.ca(this.oa))};l.Tf=function(){};xd.prototype=new Fa;xd.prototype.constructor=xd;function xd(a,b,c,d,f){this.type="dumb_stunner";this.$h=!1;this.ia(a,b,c,d,f)};yd.prototype=new Fa;l=yd.prototype;l.constructor=yd;
function yd(a,b,c,d,f){void 0!==a&&(this.type="fighter",this.ia(a,b,c,d,f),this.Sq=["frenzy"],null!==a&&(this.we=5,this.Kc=2E3,this.vj=750,this.Ee=[this.Kc,2*this.Kc],this.iA=.15,this.Cs=[!1,!1],this.cw=400,this.yl=0,this.hA=2.5*this.K,this.Zu=this.color,this.Gd=!1,this.As=10,this.Yv=2,this.sj=5,this.Vu=!1,this.Zh=!0,this.jA=this.K,this.kA=2*this.K,this.he=0,this.Py=2500,"easy"==J&&(this.Py=3500),this.uj=5,this.ze="normal",this.qh=3,this.Hg=!1,this.Tc=100,"easy"==J&&(this.Tc=80),this.lj=!1,this.JD=
...
l.Pj=function(a){Pb(-3,this.body.g.position)||a.ca(this.sj);for(var b=!1,c=0;c<this.i.Yd.length;c++)Ib(this.i.Yd[c],this.body.g.position)&&(b=!0);b?a.ca(this.dw):("frenzy"==this.ze&&0>=this.r[1]&&!this.Vu&&a.ca(this.sj),0<this.r[1]&&a.ca(.5),0<this.r[2]&&a.ca(this.fh),a.ca(this.oa))};
l.Fr=function(){if(Q(this.body.g.position,this.q.body.g.position)<=this.K*this.qh){var a=R(this.body.g.position,this.q.body.g.position);this.q.body.ha(new b2Vec2(this.Tc*Math.cos(a),this.Tc*Math.sin(a)),this.q.body.h.o)}for(a=0;a<this.i.s.length;a++)if(this.i.s[a]!==this&&Q(this.body.g.position,this.i.s[a].body.g.position)<=this.K*this.qh){var b=R(this.body.g.position,this.i.s[a].body.g.position);this.i.s[a].body.ha(new b2Vec2(this.Tc*Math.cos(b),this.Tc*Math.sin(b)),this.i.s[a].body.h.o);this.i.s[a].open(1500)}};
...
l.nr=function(){for(var a=0;a<this.i.Yd.length;a++)if(Ib(this.i.Yd[a],this.body.g.position)){this.Mc("kill");return}(-5>=this.body.g.position.x||this.body.g.position.x>=Bc/E+5||-5>=this.body.g.position.y||this.body.g.position.y>=Bc/E+5)&&this.Mc("kill")};l.Tf=function(){};Dd.prototype=new Fa;l=Dd.prototype;l.constructor=Dd;function Dd(a,b,c,d,f){void 0!==a&&(this.type="goo",this.$h=!1,this.ia(a,b,c,d,f),this.we=2,this.Gd=!1,this.Qm=3,this.rp=10,this.kg=this.Qm,this.Cj=500,this.Sk=2500,"easy"==J&&(this.Sk=3500),this.uf="small",this.ie=0,this.fh=.2,this.Kf=!1,this.hh=6E3)}
l.Uc=function(a){this.body.rb(this.body.ga()+2*Math.PI*a/this.hh);0<this.ie&&(this.ie-=a);"expanding"==this.uf?0>=this.ie?(this.uf="big",this.kg=this.rp,this.ie=this.Sk):(a=(this.Cj-this.ie)/this.Cj,a=Vb(.15,.85,a),this.kg=this.Qm*(1-a)+a*this.rp):"big"==this.uf&&0>=this.ie?(this.uf="shrinking",$b("goo"),this.ie=this.Cj):"shrinking"==this.uf&&(0>=this.ie?(this.uf="small",this.kg=this.Qm,this.ie=this.Sk):(a=(this.Cj-this.ie)/this.Cj,a=Vb(.15,.85,a),this.kg=this.Qm*a+(1-a)*this.rp));0>=this.r[1]?(this.body.re(G[this.type].wa),
...
l.qe=function(){0>=this.r[1]&&("shrinking"==this.uf?(this.ie=this.Cj-this.ie,this.uf="expanding"):"big"==this.uf?this.ie=this.Sk:"small"==this.uf&&(this.ie=this.Cj,this.uf="expanding",$b("goo")))};l.Pj=function(a){"small"!=this.uf&&0>=this.r[1]&&a.ca(this.fh);a.ca(this.oa)};Ed.prototype=new Fa;l=Ed.prototype;l.constructor=Ed;function Ed(a,b,c,d,f,g){void 0!==a&&(this.wi=g,this.type="harpoonhead",this.ia(a,b,c,d,f),this.ap=this.sl=!1)}l.Uc=function(){this.r=this.wi.r};l.qe=function(){this.wi.$b(this.wi.fq)};l.Uf=function(a){this.se=a};l.Tf=function(){};l.open=function(){};pc.prototype=new Fa;pc.prototype.constructor=pc;function pc(a,b,c,d,f){this.type="mote";this.$h=!1;this.ia(a,b,c,d,f);this.Sc=!1;this.we=5;this.Kf=!1;this.hh=2E3;this.lj=!0;this.Mm=!1;this.io=1;this.fd=3E3;"easy"==J&&(this.fd=2E3)}pc.prototype.Tf=function(){0>=this.r[1]&&this.q.$b(this.fd,!0)};pc.prototype.Uc=function(a){this.body.rb(this.body.ga()+2*Math.PI*a/this.hh)};pc.prototype.Cf=function(a,b,c,d){0<this.r[1]&&(this.body.ha(new b2Vec2(b*Math.cos(c),b*Math.sin(c)),this.body.h.o),d||this.open(this.Sj))};Cd.prototype=new Fa;l=Cd.prototype;l.constructor=Cd;function Cd(a,b,c,d,f){this.type="orbiter";this.$h=!0;this.hg=500;this.ia(a,b,c,d,f);f&&(this.Sc=!1,this.we=5,this.bq=1.25*this.q.Pg,this.js=1,this.oe=18,this.Rm=!0,this.nm=1,this.Lv=18,this.Mv=9,this.lj=!0,this.sj=2,this.no=!1,this.ms=50,this.JA=!0,this.BC=3,this.Rz=[-1,1,-4,4,-8,8,-12,12,-16,16],this.zv=4,this.Kn=0,this.Aw=250,this.Iv=G[this.type].wa,this.Mm=!1,this.io=.5,this.dC=200,this.pr=100,this.Qz=1.2*this.q.Pg,this.Pz=!1,this.Sy=2)}
l.zd=function(){};
l.Uc=function(a){this.oe=Q(this.body.g.position,this.q.body.g.position)<1.5*this.bq?this.Mv:this.Lv;this.pr-=a;if(0>this.pr){for(var b=!1,c=0;c<this.i.th.length;c++)Ib(this.i.th[c],this.body.g.position)&&(b=!0);this.$u=b;this.pr=this.dC}0<this.Kn?(this.Kn-=a,this.wa=3):this.wa=this.Iv;Gc(this,this.q.body.g.position);!this.qf&&Pb(0,this.body.g.position)&&(this.$b(this.hg,!0),this.qf=!0);0<this.yh&&(this.yh-=a);Pb(0,this.body.g.position)||(this.qf=!1,this.$b(100,!0));this.$x=(this.no=this.q.gj&&!rc(this.q,
...
l.mm=function(a){a.stroke();a.restore()};Jd.prototype=new Dd;Jd.prototype.constructor=Jd;function Jd(a,b,c,d,f){this.type="disabler";this.ia(a,b,c,d,f);this.we=2;this.Gd=!1;this.Qm=3;this.rp=9;"easy"==J&&(this.rp=8);this.kg=this.Qm;this.Cj=500;this.Sk=2500;"easy"==J&&(this.Sk=3500);this.uf="small";this.ie=0;this.Kf=!1;this.hh=6E3;this.fh=0}
...
function Gf(a){a.preventDefault();var b=Mb(a);0==a.button&&(He?He.rg(b.x,b.y):T instanceof Rf?T.rg(b.x,b.y):T.rg(b.x-Y,b.y))}function Hf(a){a.preventDefault();var b=Mb(a);0==a.button&&(He?He.Vg(b.x,b.y):T instanceof Rf?T.Vg(b.x,b.y):T.Vg(b.x-Y,b.y))}function ef(a){a.preventDefault();var b=Mb(a);if(0==a.button)if(He){if(He.Oa(b.x,b.y),T instanceof Rf)for(a=0;a<wa.length;a++)wa[a].Oa(b.x,b.y)}else if(T instanceof Rf){for(a=0;a<wa.length;a++)wa[a].Oa(b.x,b.y);T.Oa(b.x,b.y)}else T.Oa(b.x-Y,b.y)}
...
function Zf(){if(ac.Mi){var a=ac;a.Mi=!1;D.Dv=!1;$f();a.cc&&(a.Lc[a.cc].dh(D.im),a.Wj[a.cc]=!0);ac.Gm=!1;D.Gm=!1}else a=ac,a.Mi=!0,D.Dv=!0,$f(),a.cc&&(a.Lc[a.cc].dh(0),a.Wj[a.cc]=!1),ac.Gm=!0,D.Gm=!0;$f();if(He&&He instanceof Yf){var a=He,b=ac.Mi;a.Cr.Sc=b;a.fs.Sc=b}}function cf(a){a=null==a?window.event.keyCode:a.keyCode;a==ua.ft&&0==Qd&&(Qd=!0,Tf("god_mode_alert",2500,"white",0),T instanceof ag&&bg(T));a==ua.kt&&Zf();a==ua.bt&&Xf();He?He.De(a):T.De(a)}
...
" dark"];this.Fc=z["world "+this.Tm.n+" lite"];this.J=z["world "+this.Tm.n+" bright"];this.pa="BOSS"==this.V.slice(0,4);this.pa||(this.oz=parseInt(this.V.slice(this.V.length-1,this.V.length)),this.za=a.za[J]);this.sh=!1;this.Na=a.Na;this.th=[];this.Yd=[];this.Rh=[];this.Xe=[];this.ED=[];this.sf=[];this.pq=0;this.tD=20;this.wj=!1;this.Ey={stunner:Hd,spear:Gd,tank:gd,mote:pc,goo:Dd,disabler:Jd,troll:Id,fighter:yd,harpoon:tc,orbiter:Cd,slingshot:qc,deathray:ud,"first boss":Vc,"second boss":qd,"third boss":hd,
...
ya:[[300,300],[500,300],[400,200],[400,400]],Na:1,kl:50,za:{easy:[2E3,1E4,2E4],normal:[2E3,1E4,2E4]},hb:{x:400,y:300},Ri:"spread",dq:!0},"HIVE 1-1":{Nb:{stunner:[0,5,1,1,2,0,50]},s:{stunner:[0,1.5,.5,1,4,2,50]},wc:{stunner:2},Pa:{stunner:4},lb:"stunner",Ja:[[[-33,-26],[19,-26],[19,626],[-33,626]],[[833,626],[781,626],[781,-26],[833,-26]],[[144,367],[656,367],[656,626],[144,626]],[[144,-26],[656,-26],[656,233],[144,233]]],Af:[[[-33,-26],[19,-26],[19,626],[-33,626]],[[833,626],[781,626],[781,-26],[833,
25],[25,300],[-25,300]],[[-25,300],[25,300],[25,575],[400,575],[400,625],[-25,625]],[[825,300],[775,300],[775,25],[400,25],[400,-25],[825,-25]],[[825,625],[400,625],[400,575],[775,575],[775,300],[825,300]]],ya:[[60,62],[60,539],[740,62],[740,539]],Na:1,hb:{x:400,y:500},tu:90,Pa:{"fourth boss":1}}};
for(s in N)N[s].V=s,N[s].za&&"undefined"===typeof N[s].za.easy&&(N[s].za.easy=N[s].za.normal.map(function(a){return a/2})),"undefined"===typeof N[s].kl&&("BOSS"==s.slice(0,4)?N[s].kl=100*parseInt(s.slice(5,6)):"HIVE"==s.slice(0,4)&&(N[s].kl=100*parseInt(s.slice(5,6)))),"undefined"===typeof N.Or&&(N[s].Or=function(a){a=this.Ja[a];for(var b=[],c=0;c<a.length;c++)b.push(new b2Vec2(a[c][0]/E,a[c][1]/E));return b});function sg(){}l=sg.prototype;l.na=function(){};l.X=function(){};l.Ea=function(){};l.Oa=function(){};l.rg=function(){};l.Vg=function(){};l.De=function(){};l.Wp=function(){};function tg(){}tg.prototype=new sg;tg.prototype.constructor=tg;tg.prototype.Um=function(a){var b=new lg(a,this);rg(b);a=new Worker("js/lib/worker.js");a.postMessage({a:b.th,b:b.Xe,c:E,d:O,e:P});this.Yr=0;a.onmessage=function(a){return function(d){d.data.z?a.Yr=d.data.z:d.data.a&&(a.Lb=new Od(b,d.data.a,d.data.b,d.data.c,d.data.d,d.data.e,d.data.f),a.Yr=1,a.Xr())}}(this);return b};tg.prototype.Xr=function(){};ug.prototype=new sg;l=ug.prototype;l.constructor=ug;
...
l.Oa=function(a,b){for(var c=0;c<this.buttons.length;c++)this.buttons[c].Oa(a,b)};function wg(a){this.Cx=a;this.bc=null;this.ih=0}function vg(a,b,c){null==a.bc&&(a.bc=b,a.ih=a.Cx[b],a.Xx=c)}wg.prototype.na=function(a){null!=this.bc&&0<this.ih&&(this.ih-=a);null!=this.bc&&0>=this.ih&&(this.Xx&&this.Xx(),this.bc=null)};function xg(a){return a.bc?Math.min(1-a.ih/a.Cx[a.bc],1):0};yg.prototype=new sg;l=yg.prototype;l.constructor=yg;
...
l.ia=function(a,b,c,d,f,g){this.H={Ye:0,of:1,ph:1,Ze:0,je:0,mp:0,Hj:null,Yu:!1};this.L=f;if(this.hc=g)this.L.Wf=Math.floor(this.L.Wf),this.L.Id=Math.floor(this.L.Id);this.pause=!0;this.ready=!1;this.buttons=[];this.Om=null;this.ec=[];this.gA=1E3;this.aw=30;this.Na=1;this.Yb=!1;this.vf=1<=gc();this.du=!1;this.ab=0;this.n=a;this.Bn=["world "+this.n+" lite","silver","gold"];this.Xj=0;this.ND=3E3;a=new b2Vec2(0,0);this.qa=new b2World(a,!1);b&&(this.i=b,this.i.v=this,this.i.reset(),this.V=this.i.V,this.pa=
"BOSS"==this.V.slice(0,4),zg(this),"BOSS 4"==this.V?cc(ac,ja["Final Tessellation"]):"BOSS"==this.V.slice(0,4)?cc(ac,ja.Tessellation):0!=this.n&&cc(ac,ja["Hive "+this.n]));void 0===this.L.jh[this.V]&&(this.L.jh[this.V]=0);this.Lb=c;this.color=this.pa?z["boss "+this.n]:z["world "+this.n+" lite"];this.ri=z["world "+this.n+" dark"];this.Fc=z["world "+this.n+" lite"];this.J=z["world "+this.n+" bright"];this.To=6E3;this.pi=0;this.Jv=this.Qv=!1;Ag(this);c=new b2ContactListener;c.Ws=this.Vy;c.nt=this.Ly;
...
this instanceof nc||Cg(this);for(b=0;b<wa.length;b++)wa[b].color=this.color,wa[b].Za=this.J;this.eh=0==this.n||Oe.length<Dg.prototype.ls.length;this.pa&&1==this.n&&"easy"==J&&3>N[this.V].Ia[J].ab&&(this.eh=!0);this.eh&&(this.sw=new Dg(this),this.Zf={},this.Gn={},this.HA=500);!this.pa&&this.i&&Jc(this);0==this.n&&this.L&&(this.L.Id=99)};
l.reset=function(){this.H={Ye:0,of:1,ph:1,Ze:0,je:0,mp:0,Hj:null};this.Ev=1E4;this.Qj=0;this.ol=null;this.Jv=this.tj=this.Qv=!1;var a=new b2Vec2(0,0);this.qa=new b2World(a,!1);Ag(this);a=new b2ContactListener;a.Ws=this.Vy;a.nt=this.Ly;this.qa.rx(a);this.Zv=1E4;this.ab=this.bk=0;this.sa=this.yj=!1;this.i.reset();!this.i||this instanceof nc||Cg(this);Ee.translate(Y,0);this.i.Ne(Ee);Ee.translate(-Y,0);this.Xj=0;this.du=!1;this.pa&&this.eh&&(this.sw=new Dg(this),this.Zf={},this.Gn={},this.HA=500);!this.pa&&
...
l.na=function(a){if(this.ready){null==this.Om?this.Om=0:100==this.Om&&(this.Om=0);this.Om+=1;for(var b in this.Gn)this.Gn[b]-=a,0>this.Gn[b]&&(this.Zf[b]="timeout");if(!this.pause){this.eh&&(this.sw.na(a),this.yj&&Q(this.i.Ec,this.q.body.g.position)<this.i.Qk&&oc(this,"moved_to_gateway"));document.webkitHidden&&(this.pause=!0,He=new Fg(this.i,this.n,this.H,this,this.Lb));this.vr-=a;0<this.Qj?this.Qj-=a:this.ol&&(this.$v=this.ol=null);0<this.bk?this.bk-=a:this.$v&&(this.$v=this.ol=null);this.Ew?this.If=
...
this.sa=!0,this.i.sh=!0):"none"==this.Nd&&(this.ready=!1,this.Lr());else if(this.sa)"none"==this.Nd&&1==this.zoom?(Eg(this,{x:this.q.body.g.position.x*E,y:this.q.body.g.position.y*E},10,this.ew),this.Mk="out"):"none"==this.Nd&&(this.ready=!1,this.Lr(!0));else{this.pa||(b=Math.min(this.H.Ye/this.i.za[0],1),c=this.ND,this.q.O&&(c/=3),this.Xj>b?this.Xj=Math.max(this.Xj-a/c,b):this.Xj<b&&(this.Xj=Math.min(this.Xj+a/c,b)));this.UA&&1>this.On?this.On=Math.min(1,this.On+a/1E3):!this.UA&&0<this.On&&(this.On=
Math.max(0,this.On-a/1E3));this.q.na(a);this.H.of=this.H.ph+Math.floor(this.H.Ze/10);this.H.Hj=Fb(this.H.Ze);this.H.mp+=a;0<this.n&&(this.L.ci-=a);this.L.jh[this.i.V]+=a;this.H.Ze=Math.floor(this.H.mp/1E3);this.H.jh+=a;this.i.na(a);for(b=this.ec.length-1;0<=b;b--)this.ec[b].duration-=a,0>=this.ec[b].duration&&this.ec.splice(b,1);this.qa.bj(1/60,1,10);this.Uc(a)}}}};l.Uc=function(){};
...
l.X=function(a,b){if(this.ready&&!this.pause){this.ee(a,b);a.save();a.translate(Y,0);"none"!=this.Nd&&(a.rect(0,0,O,P),a.clip());a.fillStyle=this.ri;a.scale(this.zoom,this.zoom);a.translate((O/2-this.If.x*this.zoom)/this.zoom,(P/2-this.If.y*this.zoom)/this.zoom);a.beginPath();"none"!=this.Nd&&(a.rect(2,2,O-4,P-4),a.clip());Sf(this,a);"none"!=this.Nd&&a.drawImage(bg_canvas,Y,0,O,P,0,0,O,P);this.i.ah(a,E);this.q.ah(a);this.i.X(a,E);1!=this.zoom&&this.sa?(a.save(),a.translate(this.q.body.g.position.x*
...
l.rg=function(a,b){for(var c=0;c<this.buttons.length;c++)this.buttons[c].Oa(a,b);this.pause||(c=this.q,c.dv=(new Date).getTime(),c.Qp=!0)};l.Vg=function(){this.pause||(this.q.Qp=!1)};function Jg(a){a.pause=!a.pause;a.pause?(kc(a.q,ua.$i),a.q.Qp=!1,He=new Fg(a.i,a.n,a.H,a,a.Lb)):He=null}
l.De=function(a){if(this.ready){if(90==a)if(this.sa=!0,this.pa?this.i.sh=!0:this.H.Ye=this.i.za[2],Gg(this),this.hc&&0<this.n&&!this.pa){this.L.Bk=Kg(this.i,this.n);for(var b in this.H)this.L.H[this.i.V][b]=this.H[b];hg(this.L);Tf("saved_alert",1500,"white",this.n)}else this.hc&&0<this.n&&this.pa&&hg({});if(a==ua.$i||a==ua.qk)this.pa&&this.sa||this.Jv||Jg(this);else if(a==ua.Dq&&this.yj&&Q(this.i.Ec,this.q.body.g.position)<this.i.Qk)if(this.sa=!0,Gg(this),this.pa&&(this.i.sh=!0),this.hc&&0<this.n&&
...
l.Wp=function(a){if(this.ready){var b=this.q;switch(a){case ua.Jq:b.left=!1;break;case ua.Mq:b.right=!1;break;case ua.zq:b.bp=!1;break;case ua.Oq:b.qq=!1;break;case ua.ax:b.Ah=null;break;case ua.cx:b.Eh=null;break;case ua.bx:b.Ch=null;break;case ua.$w:b.zh=null;break;case ua.$i:case ua.qk:b.qq=!1,b.bp=!1,b.left=!1,b.right=!1,b.Ah=null,b.Ch=null,b.Eh=null,b.zh=null}}};
...
Lc(d.v)))}a.tB()}}}};function Hc(a,b,c,d,f,g){a.ec.push({text:b,color:c,x:d,y:f,duration:g?g:a.gA,rD:g?g:a.gA,size:20,QC:void 0})}function Jc(a){a.H.Ye>=a.i.za[0]&&0==a.ab&&(a.ab=1,a.yj=!0,a.gv=!0,a instanceof nc&&a.wj(),a.eh&&oc(a,"gateway_opened"))}function Ic(a){a.H.ph+=1;a.H.of=a.H.ph+Math.floor(a.H.Ze/10)}function Lc(a){a.q.hk||(a.eh&&!a.i.pa&&oc(a,"multiplier_reset"),a.L.Zy=!0,a.H.ph=1,a.H.of=a.H.ph+Math.floor(a.H.Ze/10))}
l.Lr=function(){T=this.hc?new Lg(this.n,this.i,this.sa||this.i.sh,this.H,this.Lb,this.L):new Mg(this.L,this.hc,{H:this.H,i:this.i,n:this.n,Lb:this.Lb,sa:this.sa})};
...
function oc(a,b){a.eh&&(a.Zf[b]="fresh",a.Gn[b]=a.HA)};Ng.prototype=new tg;l=Ng.prototype;l.constructor=Ng;
...
O/2-100,380),a.font="42px Muli",a.fillText(Fb(this.jh),O/2-100,420),a.fillStyle=this.J,a.font="20px Muli",a.fillText("DEATHS",O/2+100,380),a.font="42px Muli",a.fillText(this.Dn,O/2+100,420)):(a.globalAlpha*=.3,Ka(a,this.n,O/2,100,80),a.globalAlpha/=.3,a.fillStyle="red",a.fillText("GAME OVER",O/2,80),a.fillStyle=this.J,0<this.L.Kg&&(a.font="18px Muli",a.fillText("CONTINUES: "+this.L.Kg,O/2,175)),a.font="40px Muli",a.fillText(this.L.Sr,O/2,130));this.sa&&this.L.Kg&&(a.fillStyle=this.J,a.font="18px Muli",
a.fillText("CONTINUES: "+this.L.Kg,O/2,250));this.sa&&(a.fillStyle=this.J,a.font="14px Muli",a.fillText("TOTAL TIME",O/2,167),a.font="24px Muli",a.fillText(Fb(this.jh),O/2,190));if(!this.ak)for(a.shadowBlur=0,a.font="18px Muli",a.textAlign="center",a.fillStyle=this.J,a.fillText("LEVEL",260,250),a.fillText("TIME",400,250),a.fillText("DEATHS",540,250),b=0;8>b;b++){var c=7==b?"BOSS "+this.n:"HIVE "+this.n+"-"+(b+1),d=c;7==b&&(d=this.L.eu);var f;f=this.L.H[c]?this.L.H[c]:{};a.fillStyle=f.RA?this.J:"#666";
var g=280+27*b;a.fillText(d,260,g);a.fillStyle=f.RA?this.J:"#666";void 0!=this.L.jh[c]?a.fillText(Fb(Math.floor(this.L.jh[c]/1E3)),400,g):a.fillText("---",400,g);void 0!=f.wm?a.fillText(f.wm,540,g):a.fillText("---",540,g)}a.font="16px Muli";a.fillStyle=this.Fc;this.ak?this.Gj&&a.fillText("PRESS ANY KEY FOR MAIN MENU",O/2,P-30):a.fillText("PRESS ANY KEY FOR MAIN MENU",O/2,P-30);for(b=0;b<this.buttons.length;b++)this.buttons[b].X(a);for(b=0;b<this.buttons.length;b++)Ug(this.buttons[b],a);a.restore()}};
...
l.na=function(a){this.My=!0;if(0>this.L.Id)T=new Qg(this.n,!1,this.L,this.i,this.Lb);else if(0==this.n&&this.sa&&this.Vc&&"HIVE 0-4"==this.Vc.V)T=new Qg(this.n,!0,this.L);else if(0==this.n)this.Bi&&(T=new Rf(this.n,this.i,this.Lb,this.L,!0,null===this.sa?!0:this.sa));else if(this.Vc&&this.Vc.pa&&this.Vc.sh)T=new Qg(this.n,!0,this.L);else if(this.Vc&&this.Vc.pa&&!this.Vc.sh)T=new Rf(this.n,this.i,this.Lb,this.L,!0,null===this.sa?!0:this.sa);else{var b=this.Ba/this.Qg;"last_level_summary"==this.state&&
this.sa&&.3<b&&.7>b?(this.L.Wf+=a/(.4*this.Qg)*(this.AA+this.ey),100<=this.L.Wf&&(this.L.Wf-=100,this.L.Id+=1)):"last_level_summary"==this.state&&this.sa&&.3>b&&(this.L.Wf=Math.floor(this.Ms),this.L.Id=Math.floor(this.pw),this.L.mz=this.L.Wf,this.L.lz=this.L.Id);if(this.Bi||"world_intro"==this.state&&this.Ba>=this.Il/2||"last_level_summary"==this.state&&this.Ba>=this.Qg/2||"level_intro"==this.state&&this.Ba>=this.Oe/2)this.Ba-=a;0>this.Ba&&("world_intro"==this.state&&this.Bi?0==this.n?T=new Rf(this.n,
...
l.X=function(a,b){!this.Yb&&this.i&&(this.Yb=!0,bg_canvas.setAttribute("style","display:none"),b.translate(Y,0),this.i.Ne(b),b.translate(-Y,0),Ab(Ve.getContext("2d"),0,O,P,"Hive "+this.n));a.fillStyle=z["world "+this.n+" dark"];a.fillRect(0,0,O,P);if(0!=this.n){a.save();a.globalAlpha*=jg(this.n);if("world_intro"!=this.state||this.xC)"level_intro"==this.state?(c=this.Ba/this.Oe,.5>c&&(a.globalAlpha*=Math.min(1,(1-2*Math.abs(c-.5))/.5))):"last_level_summary"==this.state&&(c=this.Ba/this.Qg,.5<c&&(a.globalAlpha*=
...
function ag(a,b){this.Dh=b;this.Yb=!1;this.color="white";this.vf=1<=gc();this.n=a;this.Fv=null;this.tm=J;this.gs=null;this.buttons=[];var c=this;this.buttons.push(new Z("BACK",16,70,P/2+260,60,65,this.color,z.impulse_blue,function(){vg(c.U,"fade_out",function(){T=new Mf});Of("Hive 0",250,.3)},"back"));this.wh=["easy","normal"];this.tE=new dh(16,730,P/2+260,100,65,this.color,z.impulse_blue,this);this.buttons.push(this.tE);this.BD=5;this.Hl=P/2;bg(this);cc(ac,ja.Menu);this.Iy=500;this.Jy=250;this.ui=
...
function bg(a){a.Nn={};for(var b=0;b<a.wh.length;b++){var c=a.wh[b];a.Nn[c]={0:!0,1:!0,2:Je[c]["world 1"]||!1||Qd,3:Je[c]["world 2"]||!1||Qd,4:Je[c]["world 3"]||!1||Qd}}a.Vi={};a.Ph={};a.$g={};for(b=0;b<a.wh.length;b++)if(a.Vi[a.wh[b]]={},a.Ph[a.wh[b]]=[],a.$g[a.wh[b]]={},eh(a,a.wh[b]),a.Dh)fh(a,a.wh[b]),gh(a,0,a.Hl,!0,a.wh[b]);else for(var c=a,d=a.wh[b],f=0;4>=f;f++)gh(c,f,c.Hl,c.Nn[d][f],d)}
...
function jh(a,b,c,d){a.Dh&&0!=c||a.Vi[d][c].X(b);if(0<c&&a.Dh&&0!=c)for(var f=0;f<a.$g[d][c].length;f++)a.$g[d][c][f].X(b);0!=c&&(a.Dh?(b.fillStyle="white",b.font="20px Muli",b.fillText("PRACTICE MODE",O/2,a.Hl-170)):"normal"==J&&(b.fillStyle="white",b.font="24px Muli",b.fillText("HARD MODE",O/2,a.Hl-170)));b.fillStyle=z["world "+c+" bright"];b.font="42px Muli";b.textAlign="center";0<c?b.fillText("HIVE "+oa[c],O/2,a.Hl-125):b.fillText("TUTORIAL",O/2,a.Hl-125);for(f=0;f<a.Ph[d].length;f++)a.Ph[d][f].X(b),
a.Ph[d][f].Qh&&(b.textAlign="center",b.font="15px Muli",0==f?(b.fillStyle=z["world "+f+" bright"],b.fillText("TUTORIAL",O/2,P-8)):a.Ph[d][f].$c&&(b.fillStyle=z["world "+f+" bright"],b.fillText("HIVE "+oa[f],O/2,P-8)));a.Dh&&0!=c||Ug(a.Vi[d][c],b);if(0<c&&a.Dh)for(f=0;f<a.$g[d][c].length;f++)Ug(a.$g[d][c][f],b)}l.na=function(a){Ke||(null!=this.ui&&(this.ui-=a),this.Dh||this.mn(a),this.U.na(a),Qf(a))};
l.Ea=function(a,b){for(var c=0;c<this.buttons.length;c++)this.buttons[c].Ea(a,b);var d=J;if(this.Dh)if(0!=this.n)for(c=0;c<this.$g[d][this.n].length;c++)this.$g[d][this.n][c].Ea(a,b);else this.Vi[d][this.n].Ea(a,b);else this.Vi[d][this.n].Ea(a,b);for(c=0;c<this.Ph[d].length;c++)this.Ph[d][c].Ea(a,b)};
l.Oa=function(a,b){if(null==this.ui){for(var c=0;c<this.buttons.length;c++)this.buttons[c].Oa(a,b);var d=J;if(this.Dh)if(0!=this.n)for(c=0;c<this.$g[d][this.n].length;c++)this.$g[d][this.n][c].Oa(a,b);else this.Vi[d][this.n].Oa(a,b);else this.Vi[d][this.n].Oa(a,b);for(c=0;c<this.Ph[d].length;c++)this.Ph[d][c].Oa(a,b)}};l.mn=lg.prototype.mn;l.np=lg.prototype.np;l.Dm=lg.prototype.Dm;nc.prototype=new Rf;l=nc.prototype;l.constructor=nc;function nc(a){this.V="HOW TO PLAY";this.ia(0,null,null,!0,this.L,!1);this.mode=a;this.ready=!1;this.i=this.Um(N["HOW TO PLAY"]);this.i.fn=!0;this.L=new ec(0,!1);this.Rd=!1;this.eg=0;this.zm=100;this.BA=3E3;this.Ba=this.Md=500;this.ib="in"}l.Um=tg.prototype.Um;
...
l.rg=function(){};l.Vg=function(){};l.Oa=function(){};l.De=function(){};l.Wp=function(){};Fg.prototype=new Ah;l=Fg.prototype;l.constructor=Fg;
...
new Dh(a)})}}(this),"controls");this.buttons.push(this.gC);this.pu="";this.fs=new Eh("GAME MUSIC",this.x,this.y-this.m/2+this.Sh,300,30,this.J,"white",function(a){var b=ac;D.im=Math.ceil(100*Math.pow(a,2));b.cc&&!b.Mi&&b.Lc[b.cc].dh(D.im);$f()},Math.pow(D.im/100,.5));this.fs.Sc=ac.Mi;ch(this.fs,new Uf("option_game_music","white",this.n));this.buttons.push(this.fs);this.Cr=new Eh("SOUND EFFECTS",this.x,this.y-this.m/2+this.Sh+30,300,30,this.J,"white",function(a){D.Dr=Math.ceil(100*Math.pow(a,3));$f()},
...
l.Ea=function(a,b){for(var c=0;c<this.buttons.length;c++)this.buttons[c].Ea(a,b)};l.Oa=function(a,b){for(var c=0;c<this.buttons.length;c++)this.buttons[c].Oa(a,b)};l.De=function(){};l.rg=function(a,b){for(var c=0;c<this.buttons.length;c++)this.buttons[c].rg(a,b)};l.Vg=function(a,b){for(var c=0;c<this.buttons.length;c++)this.buttons[c].Vg(a,b)};Dh.prototype=new Ah;l=Dh.prototype;l.constructor=Dh;
