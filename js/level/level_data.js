...
imp_params.impulse_level_data['HIVE 1-3'] = {
  enemies_easy: {
    "stunner": [0, 2, 1.5, 1, 40],
    "spear": [30, 5, 1, 3, 15],
  },
  enemies: {
    "stunner": [0, 1, 1.5, 2, 40],
    "spear": [20, 5, 1, 3, 15],
  },
  initial_spawn_data_easy: {
    "stunner": 6
...
imp_params.impulse_level_data['HIVE 2-5'] = {
  enemies_easy: {
    "stunner": [14, 6, 1, 1, 15],
    "mote": [15, 8, 1, 1, 15],
    "harpoon": [0, 15, 1.5, 1.5, 15],
  },
  enemies: {
    "stunner": [0, 6, 1, 2, 15],
    "mote": [0, 8, 1, 1, 15],
    "harpoon": [0, 11, 1.5, 1.5, 15],
  },
...
imp_params.impulse_level_data['HIVE 3-1'] = {
  enemies_easy: {
    "stunner": [14, 14, 2, 1, 20],
    "tank":[16, 12, 1, 0.75, 10],
    "mote": [16, 14, 1, 0.6, 15],
    "fighter": [0, 18, 1, 0.5, 12]
  },
  enemies: {
    "stunner": [0, 10, 4, 2, 20],
    "tank":[0, 12, 1, 1, 10],
    "mote": [0, 12, 1, 1, 15],
    "fighter": [0, 14, 1.5, 1, 12]
  },
...
imp_params.impulse_level_data['HIVE 3-2'] = {
  enemies: {
   ...
   enemies_easy: {
      "spear": [8, 8, 1, 1, 20],
      "goo": [1, 15, 1, 0, 1],
      "fighter": [0, 20, 1, 0.75, 12],
      "harpoon": [0, 18, 1, 0.5, 12]
...
imp_params.impulse_level_data['HIVE 4-1'] = {
  ...
  enemies_easy: {
    ...
    "troll": [21, 28, 2, 1, 10],
    "tank": [28, 28, 2, 1, 10],
    "harpoon": [35, 28, 1, 1, 10],
    "slingshot": [0, 8, 1, 1, 20]
  },
...
imp_params.impulse_level_data['HIVE 4-2'] = {
  enemies_easy: {
    "stunner": [6, 6, 1, 1, 15],
    "mote": [6, 12, 1, 0.8, 10],
    "fighter": [0, 25, 1, 0.75, 8],
    "slingshot": [0, 10, 1, 0.5, 15],
    "goo": [1, 15, 1, 0, 1]
  },
  enemies: {
    "stunner": [0, 6, 2, 1, 15],
...
imp_params.impulse_level_data['HIVE 4-3'] = {
  enemies_easy: {
             "stunner": [12, 10, 1, 1, 15],
             "spear": [20, 20, 1, 1, 10],
             "tank": [17, 20, 1, 1, 15],
             "mote": [14, 20, 1, 1, 10],
             "harpoon": [17, 25, 1, 1, 10],
             "orbiter": [0, 12, 1, 1, 15]
  },
  enemies: {
             "stunner": [2, 10, 2, 1, 15],
...
imp_params.impulse_level_data['HIVE 4-4'] = {
  enemies_easy: {
            "goo":  [2, 20, 1, 0, 1],
            "troll": [4, 15, 1, 0, 1],
            "fighter": [2, 25, 1, 0.75, 5],
            "slingshot": [1, 15, 1, 1, 5],
            "orbiter": [0, 15, 1, 1, 15]
           },
  enemies: {
            "goo":  [2, 30, 1, 0, 1],
...
imp_params.impulse_level_data['HIVE 4-6'] = {
  ...
  enemies_easy: {
             "tank": [4, 15, 1, 1, 15],
             "mote": [8, 12, 1, 1, 15],
             "harpoon": [6, 18, 1, 0.75, 10],
             "fighter": [10, 24, 1, 0.5, 6],
             "disabler": [2, 16, 1, 0, 1],
             "deathray": [40, 40, 1, 1, 3]
  },
...
imp_params.impulse_level_data['HIVE 4-5'] = {
  enemies_easy: {
             ...
             "spear": [15, 10, 1, 1, 20],
             "troll":[15, 20, 1, 1, 10],
             "slingshot": [13, 20, 1, 1, 10],
             "orbiter": [10, 15, 1, 1, 10],
             "deathray": [30, 30, 1, 1, 3], 
...
imp_params.impulse_level_data['HIVE 4-7'] = {
  enemies_easy: { 
             ...
             "harpoon": [18, 40, 1, 1, 6],
             "fighter": [12, 40, 1, 1, 4],
             "disabler": [14, 15, 1, 0, 1],
             "troll": [16, 30, 1, 1, 4],
             "slingshot": [28, 40, 1, 1, 4],
             "orbiter": [22, 30, 1, 1, 5],
             "deathray": [45, 45, 1, 1, 3]
