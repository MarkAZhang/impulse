...
impulse_level_data['LEVEL 4-6'] = {
  ...
  buffer_radius: 1,
  cutoff_scores: [200000, 500000, 1500000],
  colored_interface: true
...
impulse_level_data['LEVEL 4-7'] = {
  enemies: {
             ...
             disabler: [6, 10, 1, 1, 2],
             fighter: [6, 8, 1, 1, 4],
             slingshot: [0, 10, 1, 1, 4],
             crippler: [0, 30, 1, 0, 1],         
             deathray: [0, 30, 1, .2, 4]
           },
  dominant_enemy: "deathray",
  obstacle_v:[[[0,1],[27,1],[27,579],[652,580],[652,134],[324,134],[324,336],[305,336],[305,120],[668,120],[668,600],[0,600]],[[800,600],[773,600],[773,22],[148,21],[148,467],[476,467],[476,265],[495,265],[495,481],[132,481],[132,1],[800,1]]] ,
  get_obstacle_vertices: function (index) {
    var ob_v = this.obstacle_v
