...
imp_params.impulse_level_data['HIVE 1-1'] = {
  ...
  spark_spawn_points: [[81, 75], [81, 525], [719, 75], [719, 525]],
  spark_spawn_points_easy: [[96, 75], [96, 525], [704, 75], [704, 525]],
...
imp_params.impulse_level_data['HIVE 1-6'] = {
  enemies: {
    "stunner": [6, 6, 0, 6, 2, 1, 25],
    "tank": [0, 8, 0, 8, 2, 4, 25]
  },
  enemies_easy: {
    "stunner": [3, 6, 0, 6, 2, 1, 25],
    "tank": [0, 8, 2, 2, 1, 1, 25]
  },
  initial_spawn_data: {
    "tank": 4
...
imp_params.impulse_level_data['HIVE 2-1'] = {
  enemies_easy: {
    ...
    "mote": [0, 10, 2, 4, 2, 0, 25]
  },
  enemies: {
    "stunner": [1, 4, 0, 4, 2, 2, 15],
    "tank": [0, 8, 0, 8, 2, 1, 15],
    "mote": [0, 6, 0, 6, 2, 2, 25]
  },
  initial_spawn_data: {
...
imp_params.impulse_level_data['HIVE 2-2'] = {
  enemies: {
    "stunner": [3, 3, 0, 3, 2, 1, 30],
    "spear": [0, 10, 0, 10, 4, 4, 20],
    "mote": [0, 5, 1, 2, 1, 0, 20]
  },
  enemies_easy: {
    "stunner": [5, 5, 1, 2, 1, 0, 30],
    "spear": [0, 12, 0, 12, 2, 1, 20],
    "mote": [0, 7, 1.5, 3, 1, 0, 20]
  },
  initial_spawn_data: {
    "spear": 4,
    "mote": 2
...
imp_params.impulse_level_data['HIVE 2-3'] = {
  enemies_easy: {
    "spear": [0, 8, 0, 8, 2, 1, 30],
    "tank": [0, 8, 0, 8, 2, 1, 30],
    "goo": [0, 10, 0, 10, 1, 0, 1],
  },
  enemies: {
    "spear": [0, 8, 0, 8, 4, 1, 30],
    "tank": [0, 8, 0, 8, 4, 1, 30],
    "goo": [0, 10, 0, 10, 1, 0, 1],
  },
  dominant_enemy: "goo",
...
imp_params.impulse_level_data['HIVE 2-4'] = {
  enemies: {
    ...
    "spear": [0, 2, 0.3, 1, 1.5, 0, 20],
    "mote": [0, 6, 2, 2, 1, 0, 15],
    "goo": [0, 10, 0, 10, 1, 0, 1],
  },
  enemies_easy: {
    "stunner": [8, 8, 0, 8, 2, 1, 10],
    "spear": [0, 6, 1, 1, 1.5, 1, 20],
...
imp_params.impulse_level_data['HIVE 2-5'] = {
  enemies_easy: {
    "stunner": [14, 6, 2, 2, 1, 0, 15],
    "mote": [15, 8, 2, 4, 1, 0, 15],
    "harpoon": [0, 15, 3, 6, 1.5, 0, 15],
  },
  enemies: {
...
imp_params.impulse_level_data['HIVE 2-6'] = {
  enemies: {
    "spear": [0, 10, 0, 10, 2, 2, 10],
    "tank": [2, 15, 0, 15, 2, 1, 12],
    "goo": [0, 15, 0, 15, 1, 0, 1],
    "harpoon": [0, 20, 0, 20, 2, 2, 12]
  },
  enemies_easy: {
    "spear": [0, 10, 3, 4, 1, 1, 10],
    "tank": [2, 15, 4, 3, 1, 1, 12],
    "goo": [0, 20, 0, 20, 1, 0, 1],
    "harpoon": [0, 20, 5, 6, 1, 1, 12]
  },
  dominant_enemy: "harpoon",
...
imp_params.impulse_level_data['HIVE 2-7'] = {
  ...
  enemies: {
    ...
    "spear": [22, 30, 0, 30, 4, 2, 16],
    "tank": [2, 30, 0, 30, 4, 2, 16],
    "mote": [6, 30, 0, 30, 4, 2, 16],
    "goo": [16, 30, 0, 30, 1, 0, 1],
    "harpoon": [10, 30, 0, 30, 4, 2, 16]
  },
  dominant_enemy: "harpoon",
...
imp_params.impulse_level_data['HIVE 3-1'] = {
  enemies_easy: {
    "stunner": [14, 12, 2, 6, 2, 0, 20],
    "tank":[16, 12, 3, 3, 1, 0, 10],
    "mote": [16, 12, 2, 4, 1, 0, 15],
...
/*imp_params.impulse_level_data['HIVE 3-2'] = {
  enemies: {
    "mote": [8, 8, 3, 3, 20],
    "goo": [10, 10, 1, 0, 1],
    "fighter": [12, 12, 0, 0, 12],
  },
  dominant_enemy: "fighter",
  obstacle_v: [[[-57,432],[-57,-40],[572,-40]],[[857,168],[857,640],[228,640]]],
  spawn_points: [[-100, 670], [900, -70]],
  spark_spawn_points: [[25,498],[137,578],[663,23],[775,103]],
  buffer_radius: 1,
  cutoff_scores: {
...
imp_params.impulse_level_data['HIVE 3-2'] = {
  enemies: {
    "spear": [0, 6, 0, 6, 2, 1, 20],
    "goo": [1, 15, 0, 15, 1, 0, 1],
    "fighter": [0, 18, 0, 18, 2, 2, 12],
    "harpoon": [0, 15, 3, 6, 1, 0, 12]
  },
  enemies_easy: {
    "spear": [8, 8, 1.5, 3, 1, 0, 20],
    "goo": [1, 15, 0, 15, 1, 0, 1],
    "fighter": [0, 20, 4, 8, 1, 0, 12],
    "harpoon": [0, 18, 3, 9, 1, 0, 12]
  },
  dominant_enemy: "fighter",
...
imp_params.impulse_level_data['HIVE 3-3'] = {
  ...
  enemies_easy: {
    ...
    "tank": [12, 12, 3, 3, 1, 0, 20],
    "harpoon": [16, 16, 3, 6, 1, 0, 15],
  ...
  spark_spawn_points: [[100,402],[700,402], [25,299],[775,299]],
  buffer_radius: 1.3,
  cutoff_scores: {
    "easy": [125000, 300000, 900000],
    "normal": [250000, 600000, 1750000]
  },
  initial_spawn_data: {
    "disabler": 1,
    "harpoon": 1,
...
imp_params.impulse_level_data['HIVE 3-4'] = {
  enemies: {
    "spear": [0, 4, 0, 4, 2, 2, 15],
    "fighter": [0, 10, 0, 10, 2, 1, 10],
    "mote": [0, 8, 0, 8, 2, 1, 20],
    "disabler": [0, 10, 0, 10, 1, 0, 1],
  },
  enemies_easy: {
    "spear": [0, 6, 1, 3, 1, 0, 15],
    "fighter": [0, 15, 3, 6, 1, 0, 10],
...
/*for(var i = 0; i < a.length; i++) {
  var poly = a[i];
  var mx = (poly[0].x + poly[1].x + poly[2].x + poly[3].x)/4
  var my = (poly[0].y + poly[1].y + poly[2].y + poly[3].y)/4
  var new_poly = []
  for(var j = 0; j < 4; j++) {
    new_poly.push({x: mx + 0.8 * (poly[j].x - mx), y: my + 0.8 * (poly[j].y - my)})
  }
  polys.push(new_poly)
}
*/
...
imp_params.impulse_level_data['HIVE 3-5'] = {
  enemies: {
    "spear": [0, 10, 0, 10, 2, 2, 8],
    "tank": [0, 12, 0, 12, 2, 2, 8],
    "harpoon": [0, 12, 2.4, 4.8, 1, 0, 8],
    "troll": [0, 10, 0, 10, 2, 2, 10],
  },
  enemies_easy: {
...
imp_params.impulse_level_data['HIVE 3-6'] = {
  enemies: {
    "stunner": [0, 8, 0, 8, 2, 2, 15],
    "tank": [6, 15, 3, 6, 1, 1, 10],
    "mote": [0, 10, 2, 4, 1, 1, 15],
    "fighter": [7, 20, 4, 8, 1, 1, 10],
    "troll": [0, 10, 0, 10, 2, 2, 10]
  },
  enemies_easy: {
    "stunner": [3, 10, 0, 10, 2, 1, 15],
    "tank": [6, 20, 4, 8, 1, 0, 10],
    "mote": [0, 13, 2.5, 6, 1, 0, 15],
    "fighter": [14, 20, 3, 8, 1, 0, 10],
    "troll": [0, 12, 2.5, 4, 1, 0, 10]
  },
  dominant_enemy: "troll",
...
imp_params.impulse_level_data['HIVE 3-7'] = {
  enemies: {
    "stunner": [4, 30, 0, 30, 2, 1, 10],
    "spear": [20, 30, 0, 30, 4, 2, 10],
    "tank": [8, 30, 0, 30, 2, 2, 8],
    "mote": [10, 30, 0, 30, 2, 2, 10],
    "goo": [18, 30, 0, 30, 1, 0, 1],
    "harpoon": [2, 30, 0, 30, 4, 4, 6],
    "fighter": [16, 30, 0, 30, 2, 1, 6],
    "disabler": [12, 30, 0, 30, 1, 0, 1],
    "troll": [0, 30, 0, 30, 4, 2, 10]
  },
  dominant_enemy: "troll",
...
imp_params.impulse_level_data['HIVE 4-1'] = {
  enemies: {
    "spear": [4, 16, 0, 16, 2, 2, 10],
    "troll": [8, 16, 0, 16, 2, 1, 10],
    "tank": [12, 16, 0, 16, 2, 1, 10],
    "harpoon": [16, 16, 0, 16, 2, 1, 10],
...
imp_params.impulse_level_data['HIVE 4-2'] = {
  enemies_easy: {
    "stunner": [6, 6, 1.2, 2.4, 1, 0, 15],
    "mote": [6, 12, 2, 4, 1, 0, 10],
    "fighter": [0, 25, 4, 9, 1, 0, 8],
    "slingshot": [0, 10, 1.5, 6, 1, 0, 15],
    "goo": [1, 15, 0, 15, 1, 0, 1]
  },
  enemies: {
  ...
  spark_spawn_points_easy: [[61,107],[61,493],[739,107],[739,493]],
  buffer_radius: 1,
        cutoff_scores: {
...
imp_params.impulse_level_data['HIVE 4-3'] = {
  enemies_easy: {
    "stunner": [12, 10, 2, 4, 1, 0, 15],
    "spear": [20, 20, 4, 8, 1, 0, 10],
    "tank": [17, 20, 4, 8, 1, 0, 15],
    "mote": [14, 20, 4, 8, 1, 0, 10],
    "harpoon": [17, 25, 5, 10, 1, 0, 10],
    "orbiter": [0, 12, 1.5, 6, 1, 0, 15]
  },
  enemies: {
    "stunner": [2, 5, 1, 2, 1, 0, 15],
    "spear": [6, 12, 2.4, 4.8, 1, 0, 10],
    "tank": [4, 12, 2.4, 4.8, 1, 0, 15],
    "mote": [2, 12, 2.4, 4.8, 1, 0, 10],
    "harpoon": [4, 15, 3, 6, 1, 0, 10],
    "orbiter": [0, 12, 0, 12, 2, 1, 15]
  },
...
imp_params.impulse_level_data['HIVE 4-4'] = {
  enemies_easy: {
    "goo":  [2, 20, 0, 20, 1, 0, 1],
    "troll": [4, 15, 3, 6, 1, 0, 5],
    "fighter": [2, 25, 4, 9, 1, 0, 5],
    "slingshot": [1, 15, 3, 6, 1, 0, 5],
    "orbiter": [0, 15, 3, 6, 1, 0, 10]
  },
  enemies: {
    "goo":  [2, 30, 0, 30, 1, 0, 1],
    "troll": [4, 15, 0, 15, 2, 1, 5],
    "fighter": [2, 15, 3, 6, 1, 0, 5],
    "slingshot": [1, 12, 2.4, 4.8, 1, 0, 5],
    "orbiter": [0, 12, 0, 12, 2, 2, 10]
  },
  dominant_enemy: "orbiter",
  //obstacle_v: [[[40,67],[85,67],[85,228],[40,228]],[[201,18],[252,18],[252,209],[201,209]],[[314,47],[489,47],[489,86],[314,86]],[[137,272],[314,272],[314,317],[137,317]],[[760,228],[715,228],[715,67],[760,67]],[[40,373],[85,373],[85,534],[40,534]],[[760,534],[715,534],[715,373],[760,373]],[[663,317],[486,317],[486,272],[663,272]],[[599,209],[548,209],[548,18],[599,18]],[[201,392],[252,392],[252,583],[201,583]],[[599,583],[548,583],[548,392],[599,392]],[[314,515],[489,515],[489,554],[314,554]],[[380,147],[429,147],[429,450],[380,450]]],
...
imp_params.impulse_level_data['HIVE 4-6'] = {
  enemies: {
    "tank": [2, 12, 0, 12, 2, 1, 15],
    "mote": [3, 10, 0, 10, 2, 1, 15],
    "harpoon": [5, 14, 0, 14, 2, 1, 10],
    "fighter": [1, 18, 0, 18, 2, 1, 6],
    "disabler": [4, 16, 0, 16, 1, 0, 1],
    "deathray": [30, 30, 6, 12, 1, 0, 3]
  },
  enemies_easy: {
    "tank": [4, 15, 3, 6, 1, 0, 15],
    "mote": [8, 12, 2.5, 4, 1, 0, 15],
    "harpoon": [6, 18, 3, 6, 1, 0, 10],
    "fighter": [10, 24, 4, 8, 1, 0, 6],
    "disabler": [2, 16, 0, 16, 1, 0, 1],
  ...
  obstacle_v: [[[-50,393],[-55,-44],[846,-44],[846,38],[650,37],[584,179],[683,394],[608,393],[509,178],[578,37],[380,37],[314,179],[413,393],[338,393],[239,178],[308,37],[110,37],[44,178],[143,393]],[[850,207],[855,644],[-46,644],[-46,562],[150,563],[216,422],[117,206],[192,207],[291,422],[222,563],[420,563],[486,422],[387,207],[462,207],[561,422],[492,563],[690,563],[756,422],[657,207]],[[148,88],[222,87],[192,153],[116,154]],[[418,87],[492,88],[462,154],[387,154]],[[338,446],[414,446],[382,513],[308,512]],[[608,447],[684,447],[652,512],[578,512]],[[-46,447],[144,447],[112,513],[-46,513]],[[846,153],[656,153],[688,87],[846,87]]],
  ...
  obstacle_v_easy: [[[151,93],[215,93],[189,149],[123,149]],[[421,93],[485,93],[459,149],[394,149]],[[379,507],[315,507],[341,451],[406,451]],[[649,507],[585,507],[611,451],[677,451]],[[-46,562],[155,562],[208,451],[272,451],[217,563],[425,563],[478,451],[542,451],[487,563],[695,563],[761,421],[662,207],[850,207],[855,644],[-46,644]],[[182,336],[247,336],[274,394],[209,394]],[[451,335],[516,335],[543,393],[478,393]],[[846,38],[645,38],[592,149],[528,149],[583,37],[375,37],[322,149],[258,149],[313,37],[105,37],[39,179],[138,393],[-50,393],[-55,-44],[846,-44]],[[349,265],[284,265],[257,208],[322,208]],[[618,264],[553,264],[526,207],[591,207]],[[110,508],[46,508],[72,452],[137,452]],[[690,92],[754,92],[728,148],[663,148]]],
  ...
  spawn_points: [[-100, 420], [900, 180], [-100, 540], [900, 60]],
  spark_spawn_points: [[174,421],[626,180],[714,422],[86,179]],
  buffer_radius: 1,
  cutoff_scores: {

    "normal": [500000, 1000000, 2500000],
  },
  initial_spawn_data: {
    "deathray": 1,
  },
...
imp_params.impulse_level_data['HIVE 4-5'] = {
  enemies_easy: {
    "stunner": [11, 8, 2, 3, 1, 0, 40],
    "spear": [15, 10, 2, 4, 1, 0, 20],
    "troll":[15, 20, 4, 8, 1, 0, 10],
    "slingshot": [13, 20, 4, 8, 1, 0, 10],
    "orbiter": [10, 15, 3, 6, 1, 0, 10],
  ...
  enemies: {
    "stunner": [2, 8, 0, 8, 2, 2, 40],
    "spear": [1, 10, 2, 4, 1, 1, 20],
    "troll":[5, 15, 3, 6, 1, 1, 10],
    "slingshot": [3, 15, 3, 6, 1, 1, 10],
    "orbiter": [1, 8, 1.6, 3.2, 1, 1, 10],
...
imp_params.impulse_level_data['HIVE 4-7'] = {
  enemies_easy: { 
    "stunner": [2, 30, 6, 12, 2, 0, 6],
    "spear": [4, 30, 6, 12, 2, 0, 6],
    "tank": [6, 25, 5, 10, 1, 0, 5],
    "mote": [10, 25, 5, 10, 2, 0, 6],
    "goo": [8, 20, 0, 20, 1, 0, 1],
    "harpoon": [18, 40, 8, 16, 1, 0, 6],
    "fighter": [12, 40, 8, 16, 1, 0, 4],
    "disabler": [14, 15, 3, 6, 1, 0, 1],
    "troll": [16, 30, 6, 12, 1, 0, 4],
    "slingshot": [28, 40, 8, 16, 1, 0, 4],
    "orbiter": [22, 30, 6, 12, 1, 0, 5],
    "deathray": [45, 45, 9, 18, 1, 0, 3]
  },
  enemies: {
    /*"stunner": [0, 8, 25, 2, 25],
    "spear": [0, 10, 25, 1, 25],
    ...
    "stunner": [1, 20, 3, 8, 4, 0, 6],
    "spear": [3, 20, 3, 8, 4, 0, 6],
    "tank": [4, 25, 4, 9, 3, 0, 5],
    "mote": [5, 20, 3, 12, 3, 0, 6],
    "goo": [8, 20, 0, 20, 1, 0, 1],
    "harpoon": [10, 25, 5, 10, 1, 0, 6],
    "fighter": [6, 25, 5, 10, 1, 0, 4],
    "disabler": [9, 15, 0, 15, 1, 0, 1],
    "troll": [8, 20, 3, 12, 2, 0, 4],
    "slingshot": [2, 25, 5, 10, 1, 0, 4],
    "orbiter": [2, 20, 3, 8, 2, 0, 5],
    "deathray": [31, 30, 6, 12, 1, 0, 3]
  },
  dominant_enemy: "deathray",
  ...
  spark_spawn_points: [[314,37],[486,563],[314,563],[486,37]],
  buffer_radius: 1,
