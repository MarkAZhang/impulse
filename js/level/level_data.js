...
imp_params.impulse_level_data['HIVE 1-7'] = {
  enemies_easy: {
    "stunner": [0, 4, 1, 2, 1, 0, 30],
    "spear": [0, 5, 1.5, 2, 1, 0, 15],
...
enemies: {
    ...
    "mote": [10, 30, 0, 30, 4, 2, 16],
    "goo": [20, 30, 0, 30, 1, 0, 1],
    "harpoon": [22, 30, 0, 30, 4, 2, 16]
  },
  dominant_enemy: "harpoon",
...
imp_params.impulse_level_data['HIVE 3-1'] = {
  enemies_easy: {
    "stunner": [14, 14, 2, 6, 2, 0, 20],
    "tank":[16, 12, 3, 3, 1, 0, 10],
    "mote": [16, 14, 2.5, 4, 1, 0, 15],
    "fighter": [0, 18, 3, 6, 1, 0, 12]
  },
  enemies: {
