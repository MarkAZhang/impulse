...
impulse_level_data['HIVE 1-1'] = {
  ...
  bit_spawn_points: [[75, 75], [75, 525], [725, 75], [725, 525]],
...
impulse_level_data['HIVE 2-1'] = {
  ...
  bit_spawn_points: [[400, 500], [690, 450], [110, 450]],
...
impulse_level_data['HIVE 2-2'] = {
  ...
  bit_spawn_points: [[100,85],[300, 85], [500, 85], [700, 85], [100, 515], [300, 515], [500, 515], [700,515]],
  buffer_radius: 1,
  cutoff_scores: {

    normal:   [75000, 500000, 2000000],
    easy: [40000, 150000, 1000000],
  },
  player_loc: {x: 400, y: 300}
...
impulse_level_data['HIVE 2-3'] = {
  ...
  cutoff_scores: {
    ...
    normal:  [150000, 500000, 2500000],
    easy: [75000, 250000, 1000000],
  },
  player_loc: {x:400, y:300}
...
impulse_level_data['HIVE 2-4'] = {
  ...
  bit_spawn_points: [[400, 120], [180, 460], [620, 460]],
  buffer_radius: 1,
    cutoff_scores: {

    normal:  [100000, 400000, 1250000],
    easy: [50000, 250000, 600000],
  },
...
impulse_level_data['HIVE 2-5'] = {
  ...
  bit_spawn_points: [[100, 50], [100, 300], [100, 550],[700, 50], [700, 300],[700, 550]],
      cutoff_scores: {

    normal:   [75000, 400000, 1500000],
...
impulse_level_data['HIVE 2-6'] = {
  ...
  obstacle_v: [[[129,568],[674,568],[674,613],[128,613]],[[126,119],[305,119],[305,164],[174,164],[174,236],[126,236]],[[126,364],[174,364],[174,436],[305,436],[305,481],[126,481]],[[674,236],[626,236],[626,164],[495,164],[495,119],[674,119]],[[674,481],[495,481],[495,436],[626,436],[626,364],[674,364]],[[494,323],[427,323],[427,364],[373,364],[373,323],[304,323],[304,275],[374,275],[373,236],[427,236],[427,275],[494,275]],[[-14,120],[31,120],[31,481],[-14,481]],[[814,480],[769,480],[769,119],[814,119]],[[128,-13],[674,-13],[674,32],[129,32]]],
  spawn_points: [[-100, -100], [900, -100], [-100, 700], [900, 700]],
  bit_spawn_points: [[90, 80], [710, 80], [90, 520], [710, 520]],
  initial_spawn_data: {
    spear: 2,
    mote: 2,
    harpoon: 4,
...
enemies: {
  ...
  bit_spawn_points: [[200, 93], [600, 93], [200, 507], [600, 507]],
  buffer_radius: 1,
  cutoff_scores: {
    normal:[100000, 400000, 1500000],
    easy: [60000, 200000, 1000000],
  },
  initial_spawn_data: {
    stunner: 2,
    spear: 2,
