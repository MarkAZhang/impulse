OptionButton.prototype = new ImpulseButton()

OptionButton.prototype.constructor = OptionButton

function OptionButton(text, x, y, w, h, color, action, check_verifier) {
  this.text = text;
...
OptionButton.prototype.additional_draw = function(ctx) {
  ctx.save();
  if (!this.mouseOver) {
    ctx.globalAlpha *= 0.5;
  }
