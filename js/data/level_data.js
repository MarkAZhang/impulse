...
levels['HIVE 2-7'] = {
  ...
  enemies: {
    "stunner": [2, 30, 10, 15, 4, 0, 16],
    "spear": [10, 30, 10, 15, 4, 0, 16],
    "tank": [22, 30, 10, 15, 4, 0, 16],
    "mote": [6, 30, 10, 15, 3, 0, 16],
    "goo": [16, 30, 10, 15, 1, 0, 1],
    "harpoon": [0, 30, 10, 15, 4, 0, 16]
  },
...
levels['HIVE 3-6'] = {
  enemies: {
    "spear": [2, 14, 4, 6, 2, 0, 8],
    "tank": [2, 16, 4, 8, 1, 2, 8],
    "harpoon": [0, 18, 6, 6, 1, 1, 8],
    "troll": [0, 12, 4, 6, 2, 2, 10],
  },
  enemies_easy: {
  ...
  multi_spawn_points: [[223,158],[223,443],[577,158],[577,443]],
  buffer_radius: 1,
  cutoff_scores: {
